...
APIs for [Playbooks](https://github.com/iamleson98/sitename-plugin-playbooks) are retrieved from GitHub at build time and integrated into the final YAML file.
