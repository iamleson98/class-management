...
func (p *Plugin) LogDebug(msg string, keyValuePairs ...any) {
	args := append([]any{"origin", getErrOrigin()}, keyValuePairs...)
	if isDebug != "" {
...
func (p *Plugin) LogInfo(msg string, keyValuePairs ...any) {
	args := append([]any{"origin", getErrOrigin()}, keyValuePairs...)
	p.API.LogInfo(msg, args...)
}
...
func (l *logger) fieldsToArgs(fields []logr.Field) []any {
	var buf bytes.Buffer
	args := []any{"origin", getErrOrigin()}
