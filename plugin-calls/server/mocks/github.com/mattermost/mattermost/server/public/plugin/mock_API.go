...
//   - channelId string
//   - userID string
func (_e *MockAPI_Expecter) AddChannelMember(channelId any, userID any) *MockAPI_AddChannelMember_Call {
...
func (_e *MockAPI_Expecter) AddReaction(reaction any) *MockAPI_AddReaction_Call {
...
//   - userID string
//   - asUserId string
func (_e *MockAPI_Expecter) AddUserToChannel(channelId any, userID any, asUserId any) *MockAPI_AddUserToChannel_Call {
...
//   - userID string
//   - fileIds []string
func (_e *MockAPI_Expecter) CopyFileInfos(userID any, fileIds any) *MockAPI_CopyFileInfos_Call {
...
func (_m *MockAPI) CountPropertyFields(groupID string, includeDeleted bool) (int64, error) {
...
// MockAPI_CountPropertyFields_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'CountPropertyFields'
type MockAPI_CountPropertyFields_Call struct {
	*mock.Call
}

// CountPropertyFields is a helper method to define mock.On call
//   - groupID string
//   - includeDeleted bool
func (_e *MockAPI_Expecter) CountPropertyFields(groupID any, includeDeleted any) *MockAPI_CountPropertyFields_Call {
	return &MockAPI_CountPropertyFields_Call{Call: _e.mock.On("CountPropertyFields", groupID, includeDeleted)}
}

func (_c *MockAPI_CountPropertyFields_Call) Run(run func(groupID string, includeDeleted bool)) *MockAPI_CountPropertyFields_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockAPI_CountPropertyFields_Call) Return(_a0 int64, _a1 error) *MockAPI_CountPropertyFields_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockAPI_CountPropertyFields_Call) RunAndReturn(run func(string, bool) (int64, error)) *MockAPI_CountPropertyFields_Call {
	_c.Call.Return(run)
	return _c
}

// CountPropertyFieldsForTarget provides a mock function with given fields: groupID, targetType, targetID, includeDeleted
func (_m *MockAPI) CountPropertyFieldsForTarget(groupID string, targetType string, targetID string, includeDeleted bool) (int64, error) {
...
// MockAPI_CountPropertyFieldsForTarget_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'CountPropertyFieldsForTarget'
type MockAPI_CountPropertyFieldsForTarget_Call struct {
	*mock.Call
}

// CountPropertyFieldsForTarget is a helper method to define mock.On call
//   - groupID string
//   - targetType string
//   - targetID string
//   - includeDeleted bool
func (_e *MockAPI_Expecter) CountPropertyFieldsForTarget(groupID any, targetType any, targetID any, includeDeleted any) *MockAPI_CountPropertyFieldsForTarget_Call {
	return &MockAPI_CountPropertyFieldsForTarget_Call{Call: _e.mock.On("CountPropertyFieldsForTarget", groupID, targetType, targetID, includeDeleted)}
}

func (_c *MockAPI_CountPropertyFieldsForTarget_Call) Run(run func(groupID string, targetType string, targetID string, includeDeleted bool)) *MockAPI_CountPropertyFieldsForTarget_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockAPI_CountPropertyFieldsForTarget_Call) Return(_a0 int64, _a1 error) *MockAPI_CountPropertyFieldsForTarget_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockAPI_CountPropertyFieldsForTarget_Call) RunAndReturn(run func(string, string, string, bool) (int64, error)) *MockAPI_CountPropertyFieldsForTarget_Call {
	_c.Call.Return(run)
	return _c
}
...
//   - bot *model.Bot
func (_e *MockAPI_Expecter) CreateBot(bot any) *MockAPI_CreateBot_Call {
...
func (_e *MockAPI_Expecter) CreateChannel(channel any) *MockAPI_CreateChannel_Call {
...
func (_e *MockAPI_Expecter) CreateChannelSidebarCategory(userID any, teamID any, newCategory any) *MockAPI_CreateChannelSidebarCategory_Call {
...
//   - cmd *model.Command
func (_e *MockAPI_Expecter) CreateCommand(cmd any) *MockAPI_CreateCommand_Call {
...
func (_m *MockAPI) CreateDefaultSyncableMemberships(params model.CreateDefaultMembershipParams) *model.AppError {
...
// MockAPI_CreateDefaultSyncableMemberships_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'CreateDefaultSyncableMemberships'
type MockAPI_CreateDefaultSyncableMemberships_Call struct {
	*mock.Call
}

// CreateDefaultSyncableMemberships is a helper method to define mock.On call
//   - params model.CreateDefaultMembershipParams
func (_e *MockAPI_Expecter) CreateDefaultSyncableMemberships(params any) *MockAPI_CreateDefaultSyncableMemberships_Call {
	return &MockAPI_CreateDefaultSyncableMemberships_Call{Call: _e.mock.On("CreateDefaultSyncableMemberships", params)}
}

func (_c *MockAPI_CreateDefaultSyncableMemberships_Call) Run(run func(params model.CreateDefaultMembershipParams)) *MockAPI_CreateDefaultSyncableMemberships_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(model.CreateDefaultMembershipParams))
	})
	return _c
}

func (_c *MockAPI_CreateDefaultSyncableMemberships_Call) Return(_a0 *model.AppError) *MockAPI_CreateDefaultSyncableMemberships_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockAPI_CreateDefaultSyncableMemberships_Call) RunAndReturn(run func(model.CreateDefaultMembershipParams) *model.AppError) *MockAPI_CreateDefaultSyncableMemberships_Call {
	_c.Call.Return(run)
	return _c
}

// CreateGroup provides a mock function with given fields: group
func (_m *MockAPI) CreateGroup(group *model.Group) (*model.Group, *model.AppError) {
	ret := _m.Called(group)
...
// MockAPI_CreateGroup_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'CreateGroup'
type MockAPI_CreateGroup_Call struct {
	*mock.Call
}

// CreateGroup is a helper method to define mock.On call
//   - group *model.Group
func (_e *MockAPI_Expecter) CreateGroup(group any) *MockAPI_CreateGroup_Call {
	return &MockAPI_CreateGroup_Call{Call: _e.mock.On("CreateGroup", group)}
}

func (_c *MockAPI_CreateGroup_Call) Run(run func(group *model.Group)) *MockAPI_CreateGroup_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockAPI_CreateGroup_Call) Return(_a0 *model.Group, _a1 *model.AppError) *MockAPI_CreateGroup_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockAPI_CreateGroup_Call) RunAndReturn(run func(*model.Group) (*model.Group, *model.AppError)) *MockAPI_CreateGroup_Call {
	_c.Call.Return(run)
	return _c
}
...
//   - app *model.OAuthApp
func (_e *MockAPI_Expecter) CreateOAuthApp(app any) *MockAPI_CreateOAuthApp_Call {
...
//   - post *model.Post
func (_e *MockAPI_Expecter) CreatePost(post any) *MockAPI_CreatePost_Call {
...
func (_m *MockAPI) CreatePropertyField(field *model.PropertyField) (*model.PropertyField, error) {
	ret := _m.Called(field)
...
// MockAPI_CreatePropertyField_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'CreatePropertyField'
type MockAPI_CreatePropertyField_Call struct {
	*mock.Call
}

// CreatePropertyField is a helper method to define mock.On call
//   - field *model.PropertyField
func (_e *MockAPI_Expecter) CreatePropertyField(field any) *MockAPI_CreatePropertyField_Call {
	return &MockAPI_CreatePropertyField_Call{Call: _e.mock.On("CreatePropertyField", field)}
}

func (_c *MockAPI_CreatePropertyField_Call) Run(run func(field *model.PropertyField)) *MockAPI_CreatePropertyField_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*model.PropertyField))
	})
	return _c
}

func (_c *MockAPI_CreatePropertyField_Call) Return(_a0 *model.PropertyField, _a1 error) *MockAPI_CreatePropertyField_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockAPI_CreatePropertyField_Call) RunAndReturn(run func(*model.PropertyField) (*model.PropertyField, error)) *MockAPI_CreatePropertyField_Call {
	_c.Call.Return(run)
	return _c
}

// CreatePropertyValue provides a mock function with given fields: value
func (_m *MockAPI) CreatePropertyValue(value *model.PropertyValue) (*model.PropertyValue, error) {
	ret := _m.Called(value)
...
// MockAPI_CreatePropertyValue_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'CreatePropertyValue'
type MockAPI_CreatePropertyValue_Call struct {
	*mock.Call
}

// CreatePropertyValue is a helper method to define mock.On call
//   - value *model.PropertyValue
func (_e *MockAPI_Expecter) CreatePropertyValue(value any) *MockAPI_CreatePropertyValue_Call {
	return &MockAPI_CreatePropertyValue_Call{Call: _e.mock.On("CreatePropertyValue", value)}
}

func (_c *MockAPI_CreatePropertyValue_Call) Run(run func(value *model.PropertyValue)) *MockAPI_CreatePropertyValue_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*model.PropertyValue))
	})
	return _c
}

func (_c *MockAPI_CreatePropertyValue_Call) Return(_a0 *model.PropertyValue, _a1 error) *MockAPI_CreatePropertyValue_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockAPI_CreatePropertyValue_Call) RunAndReturn(run func(*model.PropertyValue) (*model.PropertyValue, error)) *MockAPI_CreatePropertyValue_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_e *MockAPI_Expecter) CreateSession(session any) *MockAPI_CreateSession_Call {
...
//   - team *model.Team
func (_e *MockAPI_Expecter) CreateTeam(team any) *MockAPI_CreateTeam_Call {
...
//   - teamID string
//   - userID string
func (_e *MockAPI_Expecter) CreateTeamMember(teamID any, userID any) *MockAPI_CreateTeamMember_Call {
...
//   - userIds []string
//   - requestorId string
func (_e *MockAPI_Expecter) CreateTeamMembers(teamID any, userIds any, requestorId any) *MockAPI_CreateTeamMembers_Call {
...
//   - userIds []string
//   - requestorId string
func (_e *MockAPI_Expecter) CreateTeamMembersGracefully(teamID any, userIds any, requestorId any) *MockAPI_CreateTeamMembersGracefully_Call {
...
func (_e *MockAPI_Expecter) CreateUploadSession(us any) *MockAPI_CreateUploadSession_Call {
...
//   - user *model.User
func (_e *MockAPI_Expecter) CreateUser(user any) *MockAPI_CreateUser_Call {
...
func (_e *MockAPI_Expecter) CreateUserAccessToken(token any) *MockAPI_CreateUserAccessToken_Call {
...
//   - channelId string
func (_e *MockAPI_Expecter) DeleteChannel(channelId any) *MockAPI_DeleteChannel_Call {
...
//   - channelId string
//   - userID string
func (_e *MockAPI_Expecter) DeleteChannelMember(channelId any, userID any) *MockAPI_DeleteChannelMember_Call {
...
//   - commandID string
func (_e *MockAPI_Expecter) DeleteCommand(commandID any) *MockAPI_DeleteCommand_Call {
...
//   - userID string
//   - postId string
func (_e *MockAPI_Expecter) DeleteEphemeralPost(userID any, postId any) *MockAPI_DeleteEphemeralPost_Call {
...
func (_m *MockAPI) DeleteGroup(groupID string) (*model.Group, *model.AppError) {
...
// MockAPI_DeleteGroup_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'DeleteGroup'
type MockAPI_DeleteGroup_Call struct {
	*mock.Call
}

// DeleteGroup is a helper method to define mock.On call
//   - groupID string
func (_e *MockAPI_Expecter) DeleteGroup(groupID any) *MockAPI_DeleteGroup_Call {
	return &MockAPI_DeleteGroup_Call{Call: _e.mock.On("DeleteGroup", groupID)}
}

func (_c *MockAPI_DeleteGroup_Call) Run(run func(groupID string)) *MockAPI_DeleteGroup_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string))
	})
	return _c
...
func (_c *MockAPI_DeleteGroup_Call) Return(_a0 *model.Group, _a1 *model.AppError) *MockAPI_DeleteGroup_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockAPI_DeleteGroup_Call) RunAndReturn(run func(string) (*model.Group, *model.AppError)) *MockAPI_DeleteGroup_Call {
	_c.Call.Return(run)
	return _c
}

// DeleteGroupConstrainedMemberships provides a mock function with no fields
func (_m *MockAPI) DeleteGroupConstrainedMemberships() *model.AppError {
	ret := _m.Called()
...
// MockAPI_DeleteGroupConstrainedMemberships_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'DeleteGroupConstrainedMemberships'
type MockAPI_DeleteGroupConstrainedMemberships_Call struct {
	*mock.Call
}

// DeleteGroupConstrainedMemberships is a helper method to define mock.On call
func (_e *MockAPI_Expecter) DeleteGroupConstrainedMemberships() *MockAPI_DeleteGroupConstrainedMemberships_Call {
	return &MockAPI_DeleteGroupConstrainedMemberships_Call{Call: _e.mock.On("DeleteGroupConstrainedMemberships")}
}

func (_c *MockAPI_DeleteGroupConstrainedMemberships_Call) Run(run func()) *MockAPI_DeleteGroupConstrainedMemberships_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockAPI_DeleteGroupConstrainedMemberships_Call) Return(_a0 *model.AppError) *MockAPI_DeleteGroupConstrainedMemberships_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockAPI_DeleteGroupConstrainedMemberships_Call) RunAndReturn(run func() *model.AppError) *MockAPI_DeleteGroupConstrainedMemberships_Call {
	_c.Call.Return(run)
	return _c
}

// DeleteGroupMember provides a mock function with given fields: groupID, userID
func (_m *MockAPI) DeleteGroupMember(groupID string, userID string) (*model.GroupMember, *model.AppError) {
...
// MockAPI_DeleteGroupMember_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'DeleteGroupMember'
type MockAPI_DeleteGroupMember_Call struct {
	*mock.Call
}

// DeleteGroupMember is a helper method to define mock.On call
//   - groupID string
//   - userID string
func (_e *MockAPI_Expecter) DeleteGroupMember(groupID any, userID any) *MockAPI_DeleteGroupMember_Call {
	return &MockAPI_DeleteGroupMember_Call{Call: _e.mock.On("DeleteGroupMember", groupID, userID)}
}

func (_c *MockAPI_DeleteGroupMember_Call) Run(run func(groupID string, userID string)) *MockAPI_DeleteGroupMember_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string), args[1].(string))
	})
	return _c
...
func (_c *MockAPI_DeleteGroupMember_Call) Return(_a0 *model.GroupMember, _a1 *model.AppError) *MockAPI_DeleteGroupMember_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockAPI_DeleteGroupMember_Call) RunAndReturn(run func(string, string) (*model.GroupMember, *model.AppError)) *MockAPI_DeleteGroupMember_Call {
	_c.Call.Return(run)
	return _c
}

// DeleteGroupSyncable provides a mock function with given fields: groupID, syncableID, syncableType
func (_m *MockAPI) DeleteGroupSyncable(groupID string, syncableID string, syncableType model.GroupSyncableType) (*model.GroupSyncable, *model.AppError) {
...
// MockAPI_DeleteGroupSyncable_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'DeleteGroupSyncable'
type MockAPI_DeleteGroupSyncable_Call struct {
	*mock.Call
}
...
func (_e *MockAPI_Expecter) DeleteGroupSyncable(groupID any, syncableID any, syncableType any) *MockAPI_DeleteGroupSyncable_Call {
	return &MockAPI_DeleteGroupSyncable_Call{Call: _e.mock.On("DeleteGroupSyncable", groupID, syncableID, syncableType)}
}

func (_c *MockAPI_DeleteGroupSyncable_Call) Run(run func(groupID string, syncableID string, syncableType model.GroupSyncableType)) *MockAPI_DeleteGroupSyncable_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string), args[1].(string), args[2].(model.GroupSyncableType))
	})
	return _c
}

func (_c *MockAPI_DeleteGroupSyncable_Call) Return(_a0 *model.GroupSyncable, _a1 *model.AppError) *MockAPI_DeleteGroupSyncable_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockAPI_DeleteGroupSyncable_Call) RunAndReturn(run func(string, string, model.GroupSyncableType) (*model.GroupSyncable, *model.AppError)) *MockAPI_DeleteGroupSyncable_Call {
	_c.Call.Return(run)
	return _c
}
...
//   - appID string
func (_e *MockAPI_Expecter) DeleteOAuthApp(appID any) *MockAPI_DeleteOAuthApp_Call {
...
//   - postId string
func (_e *MockAPI_Expecter) DeletePost(postId any) *MockAPI_DeletePost_Call {
...
func (_e *MockAPI_Expecter) DeletePreferencesForUser(userID any, preferences any) *MockAPI_DeletePreferencesForUser_Call {
...
func (_m *MockAPI) DeletePropertyField(groupID string, fieldID string) error {
...
// MockAPI_DeletePropertyField_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'DeletePropertyField'
type MockAPI_DeletePropertyField_Call struct {
	*mock.Call
}

// DeletePropertyField is a helper method to define mock.On call
//   - groupID string
//   - fieldID string
func (_e *MockAPI_Expecter) DeletePropertyField(groupID any, fieldID any) *MockAPI_DeletePropertyField_Call {
	return &MockAPI_DeletePropertyField_Call{Call: _e.mock.On("DeletePropertyField", groupID, fieldID)}
}

func (_c *MockAPI_DeletePropertyField_Call) Run(run func(groupID string, fieldID string)) *MockAPI_DeletePropertyField_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string), args[1].(string))
	})
	return _c
...
func (_c *MockAPI_DeletePropertyField_Call) Return(_a0 error) *MockAPI_DeletePropertyField_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockAPI_DeletePropertyField_Call) RunAndReturn(run func(string, string) error) *MockAPI_DeletePropertyField_Call {
	_c.Call.Return(run)
	return _c
}

// DeletePropertyValue provides a mock function with given fields: groupID, valueID
func (_m *MockAPI) DeletePropertyValue(groupID string, valueID string) error {
...
// MockAPI_DeletePropertyValue_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'DeletePropertyValue'
type MockAPI_DeletePropertyValue_Call struct {
	*mock.Call
}

// DeletePropertyValue is a helper method to define mock.On call
//   - groupID string
//   - valueID string
func (_e *MockAPI_Expecter) DeletePropertyValue(groupID any, valueID any) *MockAPI_DeletePropertyValue_Call {
	return &MockAPI_DeletePropertyValue_Call{Call: _e.mock.On("DeletePropertyValue", groupID, valueID)}
}

func (_c *MockAPI_DeletePropertyValue_Call) Run(run func(groupID string, valueID string)) *MockAPI_DeletePropertyValue_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string), args[1].(string))
	})
	return _c
...
func (_c *MockAPI_DeletePropertyValue_Call) Return(_a0 error) *MockAPI_DeletePropertyValue_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockAPI_DeletePropertyValue_Call) RunAndReturn(run func(string, string) error) *MockAPI_DeletePropertyValue_Call {
	_c.Call.Return(run)
	return _c
}

// DeletePropertyValuesForField provides a mock function with given fields: groupID, fieldID
func (_m *MockAPI) DeletePropertyValuesForField(groupID string, fieldID string) error {
	ret := _m.Called(groupID, fieldID)
...
// MockAPI_DeletePropertyValuesForField_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'DeletePropertyValuesForField'
type MockAPI_DeletePropertyValuesForField_Call struct {
	*mock.Call
}

// DeletePropertyValuesForField is a helper method to define mock.On call
//   - groupID string
//   - fieldID string
func (_e *MockAPI_Expecter) DeletePropertyValuesForField(groupID any, fieldID any) *MockAPI_DeletePropertyValuesForField_Call {
	return &MockAPI_DeletePropertyValuesForField_Call{Call: _e.mock.On("DeletePropertyValuesForField", groupID, fieldID)}
}

func (_c *MockAPI_DeletePropertyValuesForField_Call) Run(run func(groupID string, fieldID string)) *MockAPI_DeletePropertyValuesForField_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string), args[1].(string))
	})
	return _c
...
func (_c *MockAPI_DeletePropertyValuesForField_Call) Return(_a0 error) *MockAPI_DeletePropertyValuesForField_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockAPI_DeletePropertyValuesForField_Call) RunAndReturn(run func(string, string) error) *MockAPI_DeletePropertyValuesForField_Call {
	_c.Call.Return(run)
	return _c
}

// DeletePropertyValuesForTarget provides a mock function with given fields: groupID, targetType, targetID
func (_m *MockAPI) DeletePropertyValuesForTarget(groupID string, targetType string, targetID string) error {
...
// MockAPI_DeletePropertyValuesForTarget_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'DeletePropertyValuesForTarget'
type MockAPI_DeletePropertyValuesForTarget_Call struct {
	*mock.Call
}

// DeletePropertyValuesForTarget is a helper method to define mock.On call
//   - groupID string
//   - targetType string
//   - targetID string
func (_e *MockAPI_Expecter) DeletePropertyValuesForTarget(groupID any, targetType any, targetID any) *MockAPI_DeletePropertyValuesForTarget_Call {
	return &MockAPI_DeletePropertyValuesForTarget_Call{Call: _e.mock.On("DeletePropertyValuesForTarget", groupID, targetType, targetID)}
}

func (_c *MockAPI_DeletePropertyValuesForTarget_Call) Run(run func(groupID string, targetType string, targetID string)) *MockAPI_DeletePropertyValuesForTarget_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string), args[1].(string), args[2].(string))
	})
	return _c
...
func (_c *MockAPI_DeletePropertyValuesForTarget_Call) Return(_a0 error) *MockAPI_DeletePropertyValuesForTarget_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockAPI_DeletePropertyValuesForTarget_Call) RunAndReturn(run func(string, string, string) error) *MockAPI_DeletePropertyValuesForTarget_Call {
	_c.Call.Return(run)
	return _c
}
...
//   - teamID string
func (_e *MockAPI_Expecter) DeleteTeam(teamID any) *MockAPI_DeleteTeam_Call {
...
//   - userID string
//   - requestorId string
func (_e *MockAPI_Expecter) DeleteTeamMember(teamID any, userID any, requestorId any) *MockAPI_DeleteTeamMember_Call {
...
//   - userID string
func (_e *MockAPI_Expecter) DeleteUser(userID any) *MockAPI_DeleteUser_Call {
...
//   - id string
func (_e *MockAPI_Expecter) DisablePlugin(id any) *MockAPI_DisablePlugin_Call {
...
//   - id string
func (_e *MockAPI_Expecter) EnablePlugin(id any) *MockAPI_EnablePlugin_Call {
...
//   - bot *model.Bot
func (_e *MockAPI_Expecter) EnsureBotUser(bot any) *MockAPI_EnsureBotUser_Call {
...
func (_e *MockAPI_Expecter) ExecuteSlashCommand(commandArgs any) *MockAPI_ExecuteSlashCommand_Call {
...
//   - sessionID string
//   - newExpiry int64
func (_e *MockAPI_Expecter) ExtendSessionExpiry(sessionID any, newExpiry any) *MockAPI_ExtendSessionExpiry_Call {
...
//   - botUserId string
//   - includeDeleted bool
func (_e *MockAPI_Expecter) GetBot(botUserId any, includeDeleted any) *MockAPI_GetBot_Call {
...
func (_e *MockAPI_Expecter) GetBots(options any) *MockAPI_GetBots_Call {
...
//   - channelId string
func (_e *MockAPI_Expecter) GetChannel(channelId any) *MockAPI_GetChannel_Call {
...
//   - name string
//   - includeDeleted bool
func (_e *MockAPI_Expecter) GetChannelByName(teamID any, name any, includeDeleted any) *MockAPI_GetChannelByName_Call {
...
//   - channelName string
//   - includeDeleted bool
func (_e *MockAPI_Expecter) GetChannelByNameForTeamName(teamName any, channelName any, includeDeleted any) *MockAPI_GetChannelByNameForTeamName_Call {
...
//   - channelId string
//   - userID string
func (_e *MockAPI_Expecter) GetChannelMember(channelId any, userID any) *MockAPI_GetChannelMember_Call {
...
//   - page int
//   - perPage int
func (_e *MockAPI_Expecter) GetChannelMembers(channelId any, page any, perPage any) *MockAPI_GetChannelMembers_Call {
...
//   - channelId string
//   - userIds []string
func (_e *MockAPI_Expecter) GetChannelMembersByIds(channelId any, userIds any) *MockAPI_GetChannelMembersByIds_Call {
...
//   - page int
//   - perPage int
func (_e *MockAPI_Expecter) GetChannelMembersForUser(teamID any, userID any, page any, perPage any) *MockAPI_GetChannelMembersForUser_Call {
...
//   - userID string
//   - teamID string
func (_e *MockAPI_Expecter) GetChannelSidebarCategories(userID any, teamID any) *MockAPI_GetChannelSidebarCategories_Call {
...
//   - channelId string
func (_e *MockAPI_Expecter) GetChannelStats(channelId any) *MockAPI_GetChannelStats_Call {
...
//   - userID string
//   - includeDeleted bool
func (_e *MockAPI_Expecter) GetChannelsForTeamForUser(teamID any, userID any, includeDeleted any) *MockAPI_GetChannelsForTeamForUser_Call {
...
//   - commandID string
func (_e *MockAPI_Expecter) GetCommand(commandID any) *MockAPI_GetCommand_Call {
...
//   - userId1 string
//   - userId2 string
func (_e *MockAPI_Expecter) GetDirectChannel(userId1 any, userId2 any) *MockAPI_GetDirectChannel_Call {
...
//   - emojiId string
func (_e *MockAPI_Expecter) GetEmoji(emojiId any) *MockAPI_GetEmoji_Call {
...
//   - name string
func (_e *MockAPI_Expecter) GetEmojiByName(name any) *MockAPI_GetEmojiByName_Call {
...
//   - emojiId string
func (_e *MockAPI_Expecter) GetEmojiImage(emojiId any) *MockAPI_GetEmojiImage_Call {
...
//   - page int
//   - perPage int
func (_e *MockAPI_Expecter) GetEmojiList(sortBy any, page any, perPage any) *MockAPI_GetEmojiList_Call {
...
//   - fileId string
func (_e *MockAPI_Expecter) GetFile(fileId any) *MockAPI_GetFile_Call {
...
//   - fileId string
func (_e *MockAPI_Expecter) GetFileInfo(fileId any) *MockAPI_GetFileInfo_Call {
...
func (_e *MockAPI_Expecter) GetFileInfos(page any, perPage any, opt any) *MockAPI_GetFileInfos_Call {
...
//   - fileId string
func (_e *MockAPI_Expecter) GetFileLink(fileId any) *MockAPI_GetFileLink_Call {
...
//   - groupId string
func (_e *MockAPI_Expecter) GetGroup(groupId any) *MockAPI_GetGroup_Call {
...
//   - name string
func (_e *MockAPI_Expecter) GetGroupByName(name any) *MockAPI_GetGroupByName_Call {
...
func (_m *MockAPI) GetGroupByRemoteID(remoteID string, groupSource model.GroupSource) (*model.Group, *model.AppError) {
...
// MockAPI_GetGroupByRemoteID_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetGroupByRemoteID'
type MockAPI_GetGroupByRemoteID_Call struct {
	*mock.Call
}

// GetGroupByRemoteID is a helper method to define mock.On call
//   - remoteID string
//   - groupSource model.GroupSource
func (_e *MockAPI_Expecter) GetGroupByRemoteID(remoteID any, groupSource any) *MockAPI_GetGroupByRemoteID_Call {
	return &MockAPI_GetGroupByRemoteID_Call{Call: _e.mock.On("GetGroupByRemoteID", remoteID, groupSource)}
}

func (_c *MockAPI_GetGroupByRemoteID_Call) Run(run func(remoteID string, groupSource model.GroupSource)) *MockAPI_GetGroupByRemoteID_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string), args[1].(model.GroupSource))
	})
	return _c
}

func (_c *MockAPI_GetGroupByRemoteID_Call) Return(_a0 *model.Group, _a1 *model.AppError) *MockAPI_GetGroupByRemoteID_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockAPI_GetGroupByRemoteID_Call) RunAndReturn(run func(string, model.GroupSource) (*model.Group, *model.AppError)) *MockAPI_GetGroupByRemoteID_Call {
	_c.Call.Return(run)
	return _c
}
...
//   - userIds []string
func (_e *MockAPI_Expecter) GetGroupChannel(userIds any) *MockAPI_GetGroupChannel_Call {
...
//   - page int
//   - perPage int
func (_e *MockAPI_Expecter) GetGroupMemberUsers(groupID any, page any, perPage any) *MockAPI_GetGroupMemberUsers_Call {
...
func (_m *MockAPI) GetGroupSyncable(groupID string, syncableID string, syncableType model.GroupSyncableType) (*model.GroupSyncable, *model.AppError) {
	ret := _m.Called(groupID, syncableID, syncableType)
...
// MockAPI_GetGroupSyncable_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetGroupSyncable'
type MockAPI_GetGroupSyncable_Call struct {
	*mock.Call
}
...
//   - syncableID string
//   - syncableType model.GroupSyncableType
func (_e *MockAPI_Expecter) GetGroupSyncable(groupID any, syncableID any, syncableType any) *MockAPI_GetGroupSyncable_Call {
	return &MockAPI_GetGroupSyncable_Call{Call: _e.mock.On("GetGroupSyncable", groupID, syncableID, syncableType)}
}

func (_c *MockAPI_GetGroupSyncable_Call) Run(run func(groupID string, syncableID string, syncableType model.GroupSyncableType)) *MockAPI_GetGroupSyncable_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string), args[1].(string), args[2].(model.GroupSyncableType))
	})
	return _c
...
func (_c *MockAPI_GetGroupSyncable_Call) Return(_a0 *model.GroupSyncable, _a1 *model.AppError) *MockAPI_GetGroupSyncable_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockAPI_GetGroupSyncable_Call) RunAndReturn(run func(string, string, model.GroupSyncableType) (*model.GroupSyncable, *model.AppError)) *MockAPI_GetGroupSyncable_Call {
	_c.Call.Return(run)
	return _c
}

// GetGroupSyncables provides a mock function with given fields: groupID, syncableType
func (_m *MockAPI) GetGroupSyncables(groupID string, syncableType model.GroupSyncableType) ([]*model.GroupSyncable, *model.AppError) {
...
// MockAPI_GetGroupSyncables_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetGroupSyncables'
type MockAPI_GetGroupSyncables_Call struct {
	*mock.Call
}

// GetGroupSyncables is a helper method to define mock.On call
//   - groupID string
//   - syncableType model.GroupSyncableType
func (_e *MockAPI_Expecter) GetGroupSyncables(groupID any, syncableType any) *MockAPI_GetGroupSyncables_Call {
	return &MockAPI_GetGroupSyncables_Call{Call: _e.mock.On("GetGroupSyncables", groupID, syncableType)}
}

func (_c *MockAPI_GetGroupSyncables_Call) Run(run func(groupID string, syncableType model.GroupSyncableType)) *MockAPI_GetGroupSyncables_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string), args[1].(model.GroupSyncableType))
	})
	return _c
}

func (_c *MockAPI_GetGroupSyncables_Call) Return(_a0 []*model.GroupSyncable, _a1 *model.AppError) *MockAPI_GetGroupSyncables_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockAPI_GetGroupSyncables_Call) RunAndReturn(run func(string, model.GroupSyncableType) ([]*model.GroupSyncable, *model.AppError)) *MockAPI_GetGroupSyncables_Call {
	_c.Call.Return(run)
	return _c
}

// GetGroups provides a mock function with given fields: page, perPage, opts, viewRestrictions
func (_m *MockAPI) GetGroups(page int, perPage int, opts model.GroupSearchOpts, viewRestrictions *model.ViewUsersRestrictions) ([]*model.Group, *model.AppError) {
...
// MockAPI_GetGroups_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetGroups'
type MockAPI_GetGroups_Call struct {
	*mock.Call
}
...
func (_e *MockAPI_Expecter) GetGroups(page any, perPage any, opts any, viewRestrictions any) *MockAPI_GetGroups_Call {
	return &MockAPI_GetGroups_Call{Call: _e.mock.On("GetGroups", page, perPage, opts, viewRestrictions)}
}

func (_c *MockAPI_GetGroups_Call) Run(run func(page int, perPage int, opts model.GroupSearchOpts, viewRestrictions *model.ViewUsersRestrictions)) *MockAPI_GetGroups_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(int), args[1].(int), args[2].(model.GroupSearchOpts), args[3].(*model.ViewUsersRestrictions))
	})
	return _c
}

func (_c *MockAPI_GetGroups_Call) Return(_a0 []*model.Group, _a1 *model.AppError) *MockAPI_GetGroups_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockAPI_GetGroups_Call) RunAndReturn(run func(int, int, model.GroupSearchOpts, *model.ViewUsersRestrictions) ([]*model.Group, *model.AppError)) *MockAPI_GetGroups_Call {
	_c.Call.Return(run)
	return _c
}
...
//   - groupSource model.GroupSource
func (_e *MockAPI_Expecter) GetGroupsBySource(groupSource any) *MockAPI_GetGroupsBySource_Call {
...
//   - userID string
func (_e *MockAPI_Expecter) GetGroupsForUser(userID any) *MockAPI_GetGroupsForUser_Call {
...
//   - userID string
//   - attributes []string
func (_e *MockAPI_Expecter) GetLDAPUserAttributes(userID any, attributes any) *MockAPI_GetLDAPUserAttributes_Call {
...
//   - appID string
func (_e *MockAPI_Expecter) GetOAuthApp(appID any) *MockAPI_GetOAuthApp_Call {
...
func (_m *MockAPI) GetPluginConfig() map[string]any {
	ret := _m.Called()
...
func (_c *MockAPI_GetPluginConfig_Call) Return(_a0 map[string]any) *MockAPI_GetPluginConfig_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockAPI_GetPluginConfig_Call) RunAndReturn(run func() map[string]any) *MockAPI_GetPluginConfig_Call {
	_c.Call.Return(run)
	return _c
}

// GetPluginID provides a mock function with no fields
func (_m *MockAPI) GetPluginID() string {
	ret := _m.Called()
...
// MockAPI_GetPluginID_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetPluginID'
type MockAPI_GetPluginID_Call struct {
	*mock.Call
}

// GetPluginID is a helper method to define mock.On call
func (_e *MockAPI_Expecter) GetPluginID() *MockAPI_GetPluginID_Call {
	return &MockAPI_GetPluginID_Call{Call: _e.mock.On("GetPluginID")}
}

func (_c *MockAPI_GetPluginID_Call) Run(run func()) *MockAPI_GetPluginID_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockAPI_GetPluginID_Call) Return(_a0 string) *MockAPI_GetPluginID_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockAPI_GetPluginID_Call) RunAndReturn(run func() string) *MockAPI_GetPluginID_Call {
	_c.Call.Return(run)
	return _c
}
...
//   - id string
func (_e *MockAPI_Expecter) GetPluginStatus(id any) *MockAPI_GetPluginStatus_Call {
...
//   - postId string
func (_e *MockAPI_Expecter) GetPost(postId any) *MockAPI_GetPost_Call {
...
//   - postId string
func (_e *MockAPI_Expecter) GetPostThread(postId any) *MockAPI_GetPostThread_Call {
...
//   - page int
//   - perPage int
func (_e *MockAPI_Expecter) GetPostsAfter(channelId any, postId any, page any, perPage any) *MockAPI_GetPostsAfter_Call {
...
//   - page int
//   - perPage int
func (_e *MockAPI_Expecter) GetPostsBefore(channelId any, postId any, page any, perPage any) *MockAPI_GetPostsBefore_Call {
...
//   - page int
//   - perPage int
func (_e *MockAPI_Expecter) GetPostsForChannel(channelId any, page any, perPage any) *MockAPI_GetPostsForChannel_Call {
...
//   - channelId string
//   - time int64
func (_e *MockAPI_Expecter) GetPostsSince(channelId any, time any) *MockAPI_GetPostsSince_Call {
...
//   - category string
//   - name string
func (_e *MockAPI_Expecter) GetPreferenceForUser(userID any, category any, name any) *MockAPI_GetPreferenceForUser_Call {
...
//   - userID string
func (_e *MockAPI_Expecter) GetPreferencesForUser(userID any) *MockAPI_GetPreferencesForUser_Call {
...
//   - userID string
func (_e *MockAPI_Expecter) GetProfileImage(userID any) *MockAPI_GetProfileImage_Call {
...
func (_m *MockAPI) GetPropertyField(groupID string, fieldID string) (*model.PropertyField, error) {
	ret := _m.Called(groupID, fieldID)
...
// MockAPI_GetPropertyField_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetPropertyField'
type MockAPI_GetPropertyField_Call struct {
	*mock.Call
}

// GetPropertyField is a helper method to define mock.On call
//   - groupID string
//   - fieldID string
func (_e *MockAPI_Expecter) GetPropertyField(groupID any, fieldID any) *MockAPI_GetPropertyField_Call {
	return &MockAPI_GetPropertyField_Call{Call: _e.mock.On("GetPropertyField", groupID, fieldID)}
}

func (_c *MockAPI_GetPropertyField_Call) Run(run func(groupID string, fieldID string)) *MockAPI_GetPropertyField_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string), args[1].(string))
	})
	return _c
...
func (_c *MockAPI_GetPropertyField_Call) Return(_a0 *model.PropertyField, _a1 error) *MockAPI_GetPropertyField_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockAPI_GetPropertyField_Call) RunAndReturn(run func(string, string) (*model.PropertyField, error)) *MockAPI_GetPropertyField_Call {
	_c.Call.Return(run)
	return _c
}

// GetPropertyFieldByName provides a mock function with given fields: groupID, targetID, name
func (_m *MockAPI) GetPropertyFieldByName(groupID string, targetID string, name string) (*model.PropertyField, error) {
...
// MockAPI_GetPropertyFieldByName_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetPropertyFieldByName'
type MockAPI_GetPropertyFieldByName_Call struct {
	*mock.Call
}

// GetPropertyFieldByName is a helper method to define mock.On call
//   - groupID string
//   - targetID string
//   - name string
func (_e *MockAPI_Expecter) GetPropertyFieldByName(groupID any, targetID any, name any) *MockAPI_GetPropertyFieldByName_Call {
	return &MockAPI_GetPropertyFieldByName_Call{Call: _e.mock.On("GetPropertyFieldByName", groupID, targetID, name)}
}

func (_c *MockAPI_GetPropertyFieldByName_Call) Run(run func(groupID string, targetID string, name string)) *MockAPI_GetPropertyFieldByName_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string), args[1].(string), args[2].(string))
	})
	return _c
...
func (_c *MockAPI_GetPropertyFieldByName_Call) Return(_a0 *model.PropertyField, _a1 error) *MockAPI_GetPropertyFieldByName_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockAPI_GetPropertyFieldByName_Call) RunAndReturn(run func(string, string, string) (*model.PropertyField, error)) *MockAPI_GetPropertyFieldByName_Call {
	_c.Call.Return(run)
	return _c
}

// GetPropertyFields provides a mock function with given fields: groupID, ids
func (_m *MockAPI) GetPropertyFields(groupID string, ids []string) ([]*model.PropertyField, error) {
...
// MockAPI_GetPropertyFields_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetPropertyFields'
type MockAPI_GetPropertyFields_Call struct {
	*mock.Call
}

// GetPropertyFields is a helper method to define mock.On call
//   - groupID string
//   - ids []string
func (_e *MockAPI_Expecter) GetPropertyFields(groupID any, ids any) *MockAPI_GetPropertyFields_Call {
	return &MockAPI_GetPropertyFields_Call{Call: _e.mock.On("GetPropertyFields", groupID, ids)}
}

func (_c *MockAPI_GetPropertyFields_Call) Run(run func(groupID string, ids []string)) *MockAPI_GetPropertyFields_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string), args[1].([]string))
	})
	return _c
...
func (_c *MockAPI_GetPropertyFields_Call) Return(_a0 []*model.PropertyField, _a1 error) *MockAPI_GetPropertyFields_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockAPI_GetPropertyFields_Call) RunAndReturn(run func(string, []string) ([]*model.PropertyField, error)) *MockAPI_GetPropertyFields_Call {
	_c.Call.Return(run)
	return _c
}

// GetPropertyGroup provides a mock function with given fields: name
func (_m *MockAPI) GetPropertyGroup(name string) (*model.PropertyGroup, error) {
	ret := _m.Called(name)
...
// MockAPI_GetPropertyGroup_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetPropertyGroup'
type MockAPI_GetPropertyGroup_Call struct {
	*mock.Call
}

// GetPropertyGroup is a helper method to define mock.On call
//   - name string
func (_e *MockAPI_Expecter) GetPropertyGroup(name any) *MockAPI_GetPropertyGroup_Call {
	return &MockAPI_GetPropertyGroup_Call{Call: _e.mock.On("GetPropertyGroup", name)}
}

func (_c *MockAPI_GetPropertyGroup_Call) Run(run func(name string)) *MockAPI_GetPropertyGroup_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string))
	})
	return _c
...
func (_c *MockAPI_GetPropertyGroup_Call) Return(_a0 *model.PropertyGroup, _a1 error) *MockAPI_GetPropertyGroup_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockAPI_GetPropertyGroup_Call) RunAndReturn(run func(string) (*model.PropertyGroup, error)) *MockAPI_GetPropertyGroup_Call {
	_c.Call.Return(run)
	return _c
}

// GetPropertyValue provides a mock function with given fields: groupID, valueID
func (_m *MockAPI) GetPropertyValue(groupID string, valueID string) (*model.PropertyValue, error) {
	ret := _m.Called(groupID, valueID)
...
// MockAPI_GetPropertyValue_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetPropertyValue'
type MockAPI_GetPropertyValue_Call struct {
	*mock.Call
}

// GetPropertyValue is a helper method to define mock.On call
//   - groupID string
//   - valueID string
func (_e *MockAPI_Expecter) GetPropertyValue(groupID any, valueID any) *MockAPI_GetPropertyValue_Call {
	return &MockAPI_GetPropertyValue_Call{Call: _e.mock.On("GetPropertyValue", groupID, valueID)}
}

func (_c *MockAPI_GetPropertyValue_Call) Run(run func(groupID string, valueID string)) *MockAPI_GetPropertyValue_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string), args[1].(string))
	})
	return _c
...
func (_c *MockAPI_GetPropertyValue_Call) Return(_a0 *model.PropertyValue, _a1 error) *MockAPI_GetPropertyValue_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockAPI_GetPropertyValue_Call) RunAndReturn(run func(string, string) (*model.PropertyValue, error)) *MockAPI_GetPropertyValue_Call {
	_c.Call.Return(run)
	return _c
}

// GetPropertyValues provides a mock function with given fields: groupID, ids
func (_m *MockAPI) GetPropertyValues(groupID string, ids []string) ([]*model.PropertyValue, error) {
	ret := _m.Called(groupID, ids)
...
// MockAPI_GetPropertyValues_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetPropertyValues'
type MockAPI_GetPropertyValues_Call struct {
	*mock.Call
}

// GetPropertyValues is a helper method to define mock.On call
//   - groupID string
//   - ids []string
func (_e *MockAPI_Expecter) GetPropertyValues(groupID any, ids any) *MockAPI_GetPropertyValues_Call {
	return &MockAPI_GetPropertyValues_Call{Call: _e.mock.On("GetPropertyValues", groupID, ids)}
}

func (_c *MockAPI_GetPropertyValues_Call) Run(run func(groupID string, ids []string)) *MockAPI_GetPropertyValues_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string), args[1].([]string))
	})
	return _c
...
func (_c *MockAPI_GetPropertyValues_Call) Return(_a0 []*model.PropertyValue, _a1 error) *MockAPI_GetPropertyValues_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockAPI_GetPropertyValues_Call) RunAndReturn(run func(string, []string) ([]*model.PropertyValue, error)) *MockAPI_GetPropertyValues_Call {
	_c.Call.Return(run)
	return _c
}
...
//   - page int
//   - perPage int
func (_e *MockAPI_Expecter) GetPublicChannelsForTeam(teamID any, page any, perPage any) *MockAPI_GetPublicChannelsForTeam_Call {
...
//   - postId string
func (_e *MockAPI_Expecter) GetReactions(postId any) *MockAPI_GetReactions_Call {
...
//   - sessionID string
func (_e *MockAPI_Expecter) GetSession(sessionID any) *MockAPI_GetSession_Call {
...
//   - teamID string
func (_e *MockAPI_Expecter) GetTeam(teamID any) *MockAPI_GetTeam_Call {
...
//   - name string
func (_e *MockAPI_Expecter) GetTeamByName(name any) *MockAPI_GetTeamByName_Call {
...
//   - teamID string
func (_e *MockAPI_Expecter) GetTeamIcon(teamID any) *MockAPI_GetTeamIcon_Call {
...
//   - teamID string
//   - userID string
func (_e *MockAPI_Expecter) GetTeamMember(teamID any, userID any) *MockAPI_GetTeamMember_Call {
...
//   - page int
//   - perPage int
func (_e *MockAPI_Expecter) GetTeamMembers(teamID any, page any, perPage any) *MockAPI_GetTeamMembers_Call {
...
//   - page int
//   - perPage int
func (_e *MockAPI_Expecter) GetTeamMembersForUser(userID any, page any, perPage any) *MockAPI_GetTeamMembersForUser_Call {
...
//   - teamID string
func (_e *MockAPI_Expecter) GetTeamStats(teamID any) *MockAPI_GetTeamStats_Call {
...
//   - userID string
func (_e *MockAPI_Expecter) GetTeamsForUser(userID any) *MockAPI_GetTeamsForUser_Call {
...
//   - userID string
func (_e *MockAPI_Expecter) GetTeamsUnreadForUser(userID any) *MockAPI_GetTeamsUnreadForUser_Call {
...
//   - uploadID string
func (_e *MockAPI_Expecter) GetUploadSession(uploadID any) *MockAPI_GetUploadSession_Call {
...
//   - userID string
func (_e *MockAPI_Expecter) GetUser(userID any) *MockAPI_GetUser_Call {
...
//   - email string
func (_e *MockAPI_Expecter) GetUserByEmail(email any) *MockAPI_GetUserByEmail_Call {
...
//   - name string
func (_e *MockAPI_Expecter) GetUserByUsername(name any) *MockAPI_GetUserByUsername_Call {
...
//   - userID string
func (_e *MockAPI_Expecter) GetUserStatus(userID any) *MockAPI_GetUserStatus_Call {
...
//   - userIds []string
func (_e *MockAPI_Expecter) GetUserStatusesByIds(userIds any) *MockAPI_GetUserStatusesByIds_Call {
...
func (_e *MockAPI_Expecter) GetUsers(options any) *MockAPI_GetUsers_Call {
...
//   - userIDs []string
func (_e *MockAPI_Expecter) GetUsersByIds(userIDs any) *MockAPI_GetUsersByIds_Call {
...
//   - usernames []string
func (_e *MockAPI_Expecter) GetUsersByUsernames(usernames any) *MockAPI_GetUsersByUsernames_Call {
...
//   - page int
//   - perPage int
func (_e *MockAPI_Expecter) GetUsersInChannel(channelID any, sortBy any, page any, perPage any) *MockAPI_GetUsersInChannel_Call {
...
//   - page int
//   - perPage int
func (_e *MockAPI_Expecter) GetUsersInTeam(teamID any, page any, perPage any) *MockAPI_GetUsersInTeam_Call {
...
func (_e *MockAPI_Expecter) HasPermissionTo(userID any, permission any) *MockAPI_HasPermissionTo_Call {
...
//   - channelId string
//   - permission *model.Permission
func (_e *MockAPI_Expecter) HasPermissionToChannel(userID any, channelId any, permission any) *MockAPI_HasPermissionToChannel_Call {
...
//   - teamID string
//   - permission *model.Permission
func (_e *MockAPI_Expecter) HasPermissionToTeam(userID any, teamID any, permission any) *MockAPI_HasPermissionToTeam_Call {
...
//   - file io.Reader
//   - replace bool
func (_e *MockAPI_Expecter) InstallPlugin(file any, replace any) *MockAPI_InstallPlugin_Call {
...
func (_e *MockAPI_Expecter) InviteRemoteToChannel(channelID any, remoteID any, userID any, shareIfNotShared any) *MockAPI_InviteRemoteToChannel_Call {
...
//   - key string
//   - oldValue []byte
func (_e *MockAPI_Expecter) KVCompareAndDelete(key any, oldValue any) *MockAPI_KVCompareAndDelete_Call {
...
//   - oldValue []byte
//   - newValue []byte
func (_e *MockAPI_Expecter) KVCompareAndSet(key any, oldValue any, newValue any) *MockAPI_KVCompareAndSet_Call {
...
//   - key string
func (_e *MockAPI_Expecter) KVDelete(key any) *MockAPI_KVDelete_Call {
...
//   - key string
func (_e *MockAPI_Expecter) KVGet(key any) *MockAPI_KVGet_Call {
...
//   - page int
//   - perPage int
func (_e *MockAPI_Expecter) KVList(page any, perPage any) *MockAPI_KVList_Call {
...
//   - key string
//   - value []byte
func (_e *MockAPI_Expecter) KVSet(key any, value any) *MockAPI_KVSet_Call {
...
func (_e *MockAPI_Expecter) KVSetWithExpiry(key any, value any, expireInSeconds any) *MockAPI_KVSetWithExpiry_Call {
...
func (_e *MockAPI_Expecter) KVSetWithOptions(key any, value any, options any) *MockAPI_KVSetWithOptions_Call {
...
//   - teamID string
func (_e *MockAPI_Expecter) ListCommands(teamID any) *MockAPI_ListCommands_Call {
...
//   - teamID string
func (_e *MockAPI_Expecter) ListCustomCommands(teamID any) *MockAPI_ListCustomCommands_Call {
...
//   - teamID string
func (_e *MockAPI_Expecter) ListPluginCommands(teamID any) *MockAPI_ListPluginCommands_Call {
...
func (_m *MockAPI) LoadPluginConfiguration(dest any) error {
	ret := _m.Called(dest)
...
//   - dest any
func (_e *MockAPI_Expecter) LoadPluginConfiguration(dest any) *MockAPI_LoadPluginConfiguration_Call {
	return &MockAPI_LoadPluginConfiguration_Call{Call: _e.mock.On("LoadPluginConfiguration", dest)}
}

func (_c *MockAPI_LoadPluginConfiguration_Call) Run(run func(dest any)) *MockAPI_LoadPluginConfiguration_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(any))
	})
	return _c
...
func (_c *MockAPI_LoadPluginConfiguration_Call) RunAndReturn(run func(any) error) *MockAPI_LoadPluginConfiguration_Call {
	_c.Call.Return(run)
	return _c
}

// LogAuditRec provides a mock function with given fields: rec
func (_m *MockAPI) LogAuditRec(rec *model.AuditRecord) {
	_m.Called(rec)
}

// MockAPI_LogAuditRec_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'LogAuditRec'
type MockAPI_LogAuditRec_Call struct {
	*mock.Call
}

// LogAuditRec is a helper method to define mock.On call
//   - rec *model.AuditRecord
func (_e *MockAPI_Expecter) LogAuditRec(rec any) *MockAPI_LogAuditRec_Call {
	return &MockAPI_LogAuditRec_Call{Call: _e.mock.On("LogAuditRec", rec)}
}

func (_c *MockAPI_LogAuditRec_Call) Run(run func(rec *model.AuditRecord)) *MockAPI_LogAuditRec_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*model.AuditRecord))
	})
	return _c
}

func (_c *MockAPI_LogAuditRec_Call) Return() *MockAPI_LogAuditRec_Call {
	_c.Call.Return()
	return _c
}

func (_c *MockAPI_LogAuditRec_Call) RunAndReturn(run func(*model.AuditRecord)) *MockAPI_LogAuditRec_Call {
	_c.Run(run)
	return _c
}

// LogAuditRecWithLevel provides a mock function with given fields: rec, level
func (_m *MockAPI) LogAuditRecWithLevel(rec *model.AuditRecord, level logr.Level) {
	_m.Called(rec, level)
}

// MockAPI_LogAuditRecWithLevel_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'LogAuditRecWithLevel'
type MockAPI_LogAuditRecWithLevel_Call struct {
	*mock.Call
}

// LogAuditRecWithLevel is a helper method to define mock.On call
//   - rec *model.AuditRecord
//   - level logr.Level
func (_e *MockAPI_Expecter) LogAuditRecWithLevel(rec any, level any) *MockAPI_LogAuditRecWithLevel_Call {
	return &MockAPI_LogAuditRecWithLevel_Call{Call: _e.mock.On("LogAuditRecWithLevel", rec, level)}
}

func (_c *MockAPI_LogAuditRecWithLevel_Call) Run(run func(rec *model.AuditRecord, level logr.Level)) *MockAPI_LogAuditRecWithLevel_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*model.AuditRecord), args[1].(logr.Level))
	})
	return _c
}

func (_c *MockAPI_LogAuditRecWithLevel_Call) Return() *MockAPI_LogAuditRecWithLevel_Call {
	_c.Call.Return()
	return _c
}

func (_c *MockAPI_LogAuditRecWithLevel_Call) RunAndReturn(run func(*model.AuditRecord, logr.Level)) *MockAPI_LogAuditRecWithLevel_Call {
	_c.Run(run)
	return _c
}

// LogDebug provides a mock function with given fields: msg, keyValuePairs
func (_m *MockAPI) LogDebug(msg string, keyValuePairs ...any) {
	var _ca []any
	_ca = append(_ca, msg)
...
//   - msg string
//   - keyValuePairs ...any
func (_e *MockAPI_Expecter) LogDebug(msg any, keyValuePairs ...any) *MockAPI_LogDebug_Call {
	return &MockAPI_LogDebug_Call{Call: _e.mock.On("LogDebug",
		append([]any{msg}, keyValuePairs...)...)}
}

func (_c *MockAPI_LogDebug_Call) Run(run func(msg string, keyValuePairs ...any)) *MockAPI_LogDebug_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockAPI_LogDebug_Call) RunAndReturn(run func(string, ...any)) *MockAPI_LogDebug_Call {
	_c.Run(run)
	return _c
}

// LogError provides a mock function with given fields: msg, keyValuePairs
func (_m *MockAPI) LogError(msg string, keyValuePairs ...any) {
	var _ca []any
	_ca = append(_ca, msg)
	_ca = append(_ca, keyValuePairs...)
	_m.Called(_ca...)
...
//   - msg string
//   - keyValuePairs ...any
func (_e *MockAPI_Expecter) LogError(msg any, keyValuePairs ...any) *MockAPI_LogError_Call {
	return &MockAPI_LogError_Call{Call: _e.mock.On("LogError",
		append([]any{msg}, keyValuePairs...)...)}
}

func (_c *MockAPI_LogError_Call) Run(run func(msg string, keyValuePairs ...any)) *MockAPI_LogError_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]any, len(args)-1)
		for i, a := range args[1:] {
			if a != nil {
...
func (_c *MockAPI_LogError_Call) RunAndReturn(run func(string, ...any)) *MockAPI_LogError_Call {
	_c.Run(run)
	return _c
}

// LogInfo provides a mock function with given fields: msg, keyValuePairs
func (_m *MockAPI) LogInfo(msg string, keyValuePairs ...any) {
	var _ca []any
	_ca = append(_ca, msg)
	_ca = append(_ca, keyValuePairs...)
	_m.Called(_ca...)
...
//   - msg string
//   - keyValuePairs ...any
func (_e *MockAPI_Expecter) LogInfo(msg any, keyValuePairs ...any) *MockAPI_LogInfo_Call {
	return &MockAPI_LogInfo_Call{Call: _e.mock.On("LogInfo",
		append([]any{msg}, keyValuePairs...)...)}
}

func (_c *MockAPI_LogInfo_Call) Run(run func(msg string, keyValuePairs ...any)) *MockAPI_LogInfo_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]any, len(args)-1)
		for i, a := range args[1:] {
			if a != nil {
...
func (_c *MockAPI_LogInfo_Call) RunAndReturn(run func(string, ...any)) *MockAPI_LogInfo_Call {
	_c.Run(run)
	return _c
}

// LogWarn provides a mock function with given fields: msg, keyValuePairs
func (_m *MockAPI) LogWarn(msg string, keyValuePairs ...any) {
	var _ca []any
	_ca = append(_ca, msg)
	_ca = append(_ca, keyValuePairs...)
	_m.Called(_ca...)
...
//   - msg string
//   - keyValuePairs ...any
func (_e *MockAPI_Expecter) LogWarn(msg any, keyValuePairs ...any) *MockAPI_LogWarn_Call {
	return &MockAPI_LogWarn_Call{Call: _e.mock.On("LogWarn",
		append([]any{msg}, keyValuePairs...)...)}
}

func (_c *MockAPI_LogWarn_Call) Run(run func(msg string, keyValuePairs ...any)) *MockAPI_LogWarn_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]any, len(args)-1)
		for i, a := range args[1:] {
			if a != nil {
...
func (_c *MockAPI_LogWarn_Call) RunAndReturn(run func(string, ...any)) *MockAPI_LogWarn_Call {
	_c.Run(run)
	return _c
}
...
func (_e *MockAPI_Expecter) OpenInteractiveDialog(dialog any) *MockAPI_OpenInteractiveDialog_Call {
...
func (_e *MockAPI_Expecter) PatchBot(botUserId any, botPatch any) *MockAPI_PatchBot_Call {
...
func (_e *MockAPI_Expecter) PatchChannelMembersNotifications(members any, notifyProps any) *MockAPI_PatchChannelMembersNotifications_Call {
...
//   - botUserId string
func (_e *MockAPI_Expecter) PermanentDeleteBot(botUserId any) *MockAPI_PermanentDeleteBot_Call {
...
func (_e *MockAPI_Expecter) PluginHTTP(request any) *MockAPI_PluginHTTP_Call {
...
func (_e *MockAPI_Expecter) PublishPluginClusterEvent(ev any, opts any) *MockAPI_PublishPluginClusterEvent_Call {
...
//   - channelId string
//   - parentId string
func (_e *MockAPI_Expecter) PublishUserTyping(userID any, channelId any, parentId any) *MockAPI_PublishUserTyping_Call {
...
func (_m *MockAPI) PublishWebSocketEvent(event string, payload map[string]any, broadcast *model.WebsocketBroadcast) {
...
func (_e *MockAPI_Expecter) PublishWebSocketEvent(event any, payload any, broadcast any) *MockAPI_PublishWebSocketEvent_Call {
	return &MockAPI_PublishWebSocketEvent_Call{Call: _e.mock.On("PublishWebSocketEvent", event, payload, broadcast)}
}

func (_c *MockAPI_PublishWebSocketEvent_Call) Run(run func(event string, payload map[string]any, broadcast *model.WebsocketBroadcast)) *MockAPI_PublishWebSocketEvent_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string), args[1].(map[string]any), args[2].(*model.WebsocketBroadcast))
	})
	return _c
}
...
func (_c *MockAPI_PublishWebSocketEvent_Call) RunAndReturn(run func(string, map[string]any, *model.WebsocketBroadcast)) *MockAPI_PublishWebSocketEvent_Call {
	_c.Run(run)
	return _c
}
...
//   - path string
func (_e *MockAPI_Expecter) ReadFile(path any) *MockAPI_ReadFile_Call {
...
func (_m *MockAPI) ReceiveSharedChannelAttachmentSyncMsg(remoteID string, channelID string, fi *model.FileInfo, data io.Reader) (*model.FileInfo, error) {
...
// MockAPI_ReceiveSharedChannelAttachmentSyncMsg_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ReceiveSharedChannelAttachmentSyncMsg'
type MockAPI_ReceiveSharedChannelAttachmentSyncMsg_Call struct {
	*mock.Call
}

// ReceiveSharedChannelAttachmentSyncMsg is a helper method to define mock.On call
//   - remoteID string
//   - channelID string
//   - fi *model.FileInfo
//   - data io.Reader
func (_e *MockAPI_Expecter) ReceiveSharedChannelAttachmentSyncMsg(remoteID any, channelID any, fi any, data any) *MockAPI_ReceiveSharedChannelAttachmentSyncMsg_Call {
	return &MockAPI_ReceiveSharedChannelAttachmentSyncMsg_Call{Call: _e.mock.On("ReceiveSharedChannelAttachmentSyncMsg", remoteID, channelID, fi, data)}
}

func (_c *MockAPI_ReceiveSharedChannelAttachmentSyncMsg_Call) Run(run func(remoteID string, channelID string, fi *model.FileInfo, data io.Reader)) *MockAPI_ReceiveSharedChannelAttachmentSyncMsg_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string), args[1].(string), args[2].(*model.FileInfo), args[3].(io.Reader))
	})
	return _c
}

func (_c *MockAPI_ReceiveSharedChannelAttachmentSyncMsg_Call) Return(_a0 *model.FileInfo, _a1 error) *MockAPI_ReceiveSharedChannelAttachmentSyncMsg_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockAPI_ReceiveSharedChannelAttachmentSyncMsg_Call) RunAndReturn(run func(string, string, *model.FileInfo, io.Reader) (*model.FileInfo, error)) *MockAPI_ReceiveSharedChannelAttachmentSyncMsg_Call {
	_c.Call.Return(run)
	return _c
}

// ReceiveSharedChannelProfileImageSyncMsg provides a mock function with given fields: remoteID, userID, image
func (_m *MockAPI) ReceiveSharedChannelProfileImageSyncMsg(remoteID string, userID string, image []byte) error {
...
// MockAPI_ReceiveSharedChannelProfileImageSyncMsg_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ReceiveSharedChannelProfileImageSyncMsg'
type MockAPI_ReceiveSharedChannelProfileImageSyncMsg_Call struct {
	*mock.Call
}

// ReceiveSharedChannelProfileImageSyncMsg is a helper method to define mock.On call
//   - remoteID string
//   - userID string
//   - image []byte
func (_e *MockAPI_Expecter) ReceiveSharedChannelProfileImageSyncMsg(remoteID any, userID any, image any) *MockAPI_ReceiveSharedChannelProfileImageSyncMsg_Call {
	return &MockAPI_ReceiveSharedChannelProfileImageSyncMsg_Call{Call: _e.mock.On("ReceiveSharedChannelProfileImageSyncMsg", remoteID, userID, image)}
}

func (_c *MockAPI_ReceiveSharedChannelProfileImageSyncMsg_Call) Run(run func(remoteID string, userID string, image []byte)) *MockAPI_ReceiveSharedChannelProfileImageSyncMsg_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockAPI_ReceiveSharedChannelProfileImageSyncMsg_Call) Return(_a0 error) *MockAPI_ReceiveSharedChannelProfileImageSyncMsg_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockAPI_ReceiveSharedChannelProfileImageSyncMsg_Call) RunAndReturn(run func(string, string, []byte) error) *MockAPI_ReceiveSharedChannelProfileImageSyncMsg_Call {
	_c.Call.Return(run)
	return _c
}

// ReceiveSharedChannelSyncMsg provides a mock function with given fields: remoteID, msg
func (_m *MockAPI) ReceiveSharedChannelSyncMsg(remoteID string, msg *model.SyncMsg) (model.SyncResponse, error) {
...
// MockAPI_ReceiveSharedChannelSyncMsg_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ReceiveSharedChannelSyncMsg'
type MockAPI_ReceiveSharedChannelSyncMsg_Call struct {
	*mock.Call
}

// ReceiveSharedChannelSyncMsg is a helper method to define mock.On call
//   - remoteID string
//   - msg *model.SyncMsg
func (_e *MockAPI_Expecter) ReceiveSharedChannelSyncMsg(remoteID any, msg any) *MockAPI_ReceiveSharedChannelSyncMsg_Call {
	return &MockAPI_ReceiveSharedChannelSyncMsg_Call{Call: _e.mock.On("ReceiveSharedChannelSyncMsg", remoteID, msg)}
}

func (_c *MockAPI_ReceiveSharedChannelSyncMsg_Call) Run(run func(remoteID string, msg *model.SyncMsg)) *MockAPI_ReceiveSharedChannelSyncMsg_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string), args[1].(*model.SyncMsg))
	})
	return _c
}

func (_c *MockAPI_ReceiveSharedChannelSyncMsg_Call) Return(_a0 model.SyncResponse, _a1 error) *MockAPI_ReceiveSharedChannelSyncMsg_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockAPI_ReceiveSharedChannelSyncMsg_Call) RunAndReturn(run func(string, *model.SyncMsg) (model.SyncResponse, error)) *MockAPI_ReceiveSharedChannelSyncMsg_Call {
	_c.Call.Return(run)
	return _c
}

// RegisterChannelGuard provides a mock function with given fields: channelID
func (_m *MockAPI) RegisterChannelGuard(channelID string) *model.AppError {
	ret := _m.Called(channelID)
...
// MockAPI_RegisterChannelGuard_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'RegisterChannelGuard'
type MockAPI_RegisterChannelGuard_Call struct {
	*mock.Call
}

// RegisterChannelGuard is a helper method to define mock.On call
//   - channelID string
func (_e *MockAPI_Expecter) RegisterChannelGuard(channelID any) *MockAPI_RegisterChannelGuard_Call {
	return &MockAPI_RegisterChannelGuard_Call{Call: _e.mock.On("RegisterChannelGuard", channelID)}
}

func (_c *MockAPI_RegisterChannelGuard_Call) Run(run func(channelID string)) *MockAPI_RegisterChannelGuard_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string))
	})
	return _c
...
func (_c *MockAPI_RegisterChannelGuard_Call) Return(_a0 *model.AppError) *MockAPI_RegisterChannelGuard_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockAPI_RegisterChannelGuard_Call) RunAndReturn(run func(string) *model.AppError) *MockAPI_RegisterChannelGuard_Call {
	_c.Call.Return(run)
	return _c
}
...
//   - topicType string
func (_e *MockAPI_Expecter) RegisterCollectionAndTopic(collectionType any, topicType any) *MockAPI_RegisterCollectionAndTopic_Call {
...
func (_e *MockAPI_Expecter) RegisterCommand(command any) *MockAPI_RegisterCommand_Call {
...
func (_e *MockAPI_Expecter) RegisterPluginForSharedChannels(opts any) *MockAPI_RegisterPluginForSharedChannels_Call {
...
func (_m *MockAPI) RegisterPropertyGroup(name string) (*model.PropertyGroup, error) {
	ret := _m.Called(name)
...
// MockAPI_RegisterPropertyGroup_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'RegisterPropertyGroup'
type MockAPI_RegisterPropertyGroup_Call struct {
	*mock.Call
}

// RegisterPropertyGroup is a helper method to define mock.On call
//   - name string
func (_e *MockAPI_Expecter) RegisterPropertyGroup(name any) *MockAPI_RegisterPropertyGroup_Call {
	return &MockAPI_RegisterPropertyGroup_Call{Call: _e.mock.On("RegisterPropertyGroup", name)}
}

func (_c *MockAPI_RegisterPropertyGroup_Call) Run(run func(name string)) *MockAPI_RegisterPropertyGroup_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string))
	})
	return _c
...
func (_c *MockAPI_RegisterPropertyGroup_Call) Return(_a0 *model.PropertyGroup, _a1 error) *MockAPI_RegisterPropertyGroup_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockAPI_RegisterPropertyGroup_Call) RunAndReturn(run func(string) (*model.PropertyGroup, error)) *MockAPI_RegisterPropertyGroup_Call {
	_c.Call.Return(run)
	return _c
}
...
//   - id string
func (_e *MockAPI_Expecter) RemovePlugin(id any) *MockAPI_RemovePlugin_Call {
...
//   - reaction *model.Reaction
func (_e *MockAPI_Expecter) RemoveReaction(reaction any) *MockAPI_RemoveReaction_Call {
...
//   - teamID string
func (_e *MockAPI_Expecter) RemoveTeamIcon(teamID any) *MockAPI_RemoveTeamIcon_Call {
...
//   - userID string
func (_e *MockAPI_Expecter) RemoveUserCustomStatus(userID any) *MockAPI_RemoveUserCustomStatus_Call {
...
func (_e *MockAPI_Expecter) RequestTrialLicense(requesterID any, users any, termsAccepted any, receiveEmailsAccepted any) *MockAPI_RequestTrialLicense_Call {
...
func (_m *MockAPI) RestoreGroup(groupID string) (*model.Group, *model.AppError) {
	ret := _m.Called(groupID)
...
// MockAPI_RestoreGroup_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'RestoreGroup'
type MockAPI_RestoreGroup_Call struct {
	*mock.Call
}

// RestoreGroup is a helper method to define mock.On call
//   - groupID string
func (_e *MockAPI_Expecter) RestoreGroup(groupID any) *MockAPI_RestoreGroup_Call {
	return &MockAPI_RestoreGroup_Call{Call: _e.mock.On("RestoreGroup", groupID)}
}

func (_c *MockAPI_RestoreGroup_Call) Run(run func(groupID string)) *MockAPI_RestoreGroup_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string))
	})
	return _c
...
func (_c *MockAPI_RestoreGroup_Call) Return(_a0 *model.Group, _a1 *model.AppError) *MockAPI_RestoreGroup_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockAPI_RestoreGroup_Call) RunAndReturn(run func(string) (*model.Group, *model.AppError)) *MockAPI_RestoreGroup_Call {
	_c.Call.Return(run)
	return _c
}
...
//   - sessionID string
func (_e *MockAPI_Expecter) RevokeSession(sessionID any) *MockAPI_RevokeSession_Call {
...
//   - tokenID string
func (_e *MockAPI_Expecter) RevokeUserAccessToken(tokenID any) *MockAPI_RevokeUserAccessToken_Call {
...
//   - roleNames []string
//   - permissionId string
func (_e *MockAPI_Expecter) RolesGrantPermission(roleNames any, permissionId any) *MockAPI_RolesGrantPermission_Call {
...
//   - config *model.Config
func (_e *MockAPI_Expecter) SaveConfig(config any) *MockAPI_SaveConfig_Call {
...
func (_m *MockAPI) SavePluginConfig(config map[string]any) *model.AppError {
	ret := _m.Called(config)
...
func (_e *MockAPI_Expecter) SavePluginConfig(config any) *MockAPI_SavePluginConfig_Call {
	return &MockAPI_SavePluginConfig_Call{Call: _e.mock.On("SavePluginConfig", config)}
}

func (_c *MockAPI_SavePluginConfig_Call) Run(run func(config map[string]any)) *MockAPI_SavePluginConfig_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockAPI_SavePluginConfig_Call) RunAndReturn(run func(map[string]any) *model.AppError) *MockAPI_SavePluginConfig_Call {
	_c.Call.Return(run)
	return _c
}
...
//   - teamID string
//   - term string
func (_e *MockAPI_Expecter) SearchChannels(teamID any, term any) *MockAPI_SearchChannels_Call {
...
func (_e *MockAPI_Expecter) SearchPostsInTeam(teamID any, paramsList any) *MockAPI_SearchPostsInTeam_Call {
...
func (_e *MockAPI_Expecter) SearchPostsInTeamForUser(teamID any, userID any, searchParams any) *MockAPI_SearchPostsInTeamForUser_Call {
...
func (_m *MockAPI) SearchPropertyFields(groupID string, opts model.PropertyFieldSearchOpts) ([]*model.PropertyField, error) {
...
// MockAPI_SearchPropertyFields_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SearchPropertyFields'
type MockAPI_SearchPropertyFields_Call struct {
	*mock.Call
}
...
func (_e *MockAPI_Expecter) SearchPropertyFields(groupID any, opts any) *MockAPI_SearchPropertyFields_Call {
	return &MockAPI_SearchPropertyFields_Call{Call: _e.mock.On("SearchPropertyFields", groupID, opts)}
}

func (_c *MockAPI_SearchPropertyFields_Call) Run(run func(groupID string, opts model.PropertyFieldSearchOpts)) *MockAPI_SearchPropertyFields_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string), args[1].(model.PropertyFieldSearchOpts))
	})
	return _c
}

func (_c *MockAPI_SearchPropertyFields_Call) Return(_a0 []*model.PropertyField, _a1 error) *MockAPI_SearchPropertyFields_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockAPI_SearchPropertyFields_Call) RunAndReturn(run func(string, model.PropertyFieldSearchOpts) ([]*model.PropertyField, error)) *MockAPI_SearchPropertyFields_Call {
	_c.Call.Return(run)
	return _c
}

// SearchPropertyValues provides a mock function with given fields: groupID, opts
func (_m *MockAPI) SearchPropertyValues(groupID string, opts model.PropertyValueSearchOpts) ([]*model.PropertyValue, error) {
	ret := _m.Called(groupID, opts)
...
// MockAPI_SearchPropertyValues_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SearchPropertyValues'
type MockAPI_SearchPropertyValues_Call struct {
	*mock.Call
}
...
func (_e *MockAPI_Expecter) SearchPropertyValues(groupID any, opts any) *MockAPI_SearchPropertyValues_Call {
	return &MockAPI_SearchPropertyValues_Call{Call: _e.mock.On("SearchPropertyValues", groupID, opts)}
}

func (_c *MockAPI_SearchPropertyValues_Call) Run(run func(groupID string, opts model.PropertyValueSearchOpts)) *MockAPI_SearchPropertyValues_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string), args[1].(model.PropertyValueSearchOpts))
	})
	return _c
}

func (_c *MockAPI_SearchPropertyValues_Call) Return(_a0 []*model.PropertyValue, _a1 error) *MockAPI_SearchPropertyValues_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockAPI_SearchPropertyValues_Call) RunAndReturn(run func(string, model.PropertyValueSearchOpts) ([]*model.PropertyValue, error)) *MockAPI_SearchPropertyValues_Call {
	_c.Call.Return(run)
	return _c
}
...
//   - term string
func (_e *MockAPI_Expecter) SearchTeams(term any) *MockAPI_SearchTeams_Call {
...
func (_e *MockAPI_Expecter) SearchUsers(search any) *MockAPI_SearchUsers_Call {
...
//   - userID string
//   - post *model.Post
func (_e *MockAPI_Expecter) SendEphemeralPost(userID any, post any) *MockAPI_SendEphemeralPost_Call {
...
//   - subject string
//   - htmlBody string
func (_e *MockAPI_Expecter) SendMail(to any, subject any, htmlBody any) *MockAPI_SendMail_Call {
...
//   - userID string
func (_e *MockAPI_Expecter) SendPushNotification(notification any, userID any) *MockAPI_SendPushNotification_Call {
...
func (_m *MockAPI) SendToastMessage(userID string, connectionID string, message string, options model.SendToastMessageOptions) *model.AppError {
...
// MockAPI_SendToastMessage_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SendToastMessage'
type MockAPI_SendToastMessage_Call struct {
	*mock.Call
}

// SendToastMessage is a helper method to define mock.On call
//   - userID string
//   - connectionID string
//   - message string
//   - options model.SendToastMessageOptions
func (_e *MockAPI_Expecter) SendToastMessage(userID any, connectionID any, message any, options any) *MockAPI_SendToastMessage_Call {
	return &MockAPI_SendToastMessage_Call{Call: _e.mock.On("SendToastMessage", userID, connectionID, message, options)}
}

func (_c *MockAPI_SendToastMessage_Call) Run(run func(userID string, connectionID string, message string, options model.SendToastMessageOptions)) *MockAPI_SendToastMessage_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string), args[1].(string), args[2].(string), args[3].(model.SendToastMessageOptions))
	})
	return _c
}

func (_c *MockAPI_SendToastMessage_Call) Return(_a0 *model.AppError) *MockAPI_SendToastMessage_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockAPI_SendToastMessage_Call) RunAndReturn(run func(string, string, string, model.SendToastMessageOptions) *model.AppError) *MockAPI_SendToastMessage_Call {
	_c.Call.Return(run)
	return _c
}
...
//   - fileID string
//   - content string
func (_e *MockAPI_Expecter) SetFileSearchableContent(fileID any, content any) *MockAPI_SetFileSearchableContent_Call {
...
//   - userID string
//   - data []byte
func (_e *MockAPI_Expecter) SetProfileImage(userID any, data any) *MockAPI_SetProfileImage_Call {
...
//   - teamID string
//   - data []byte
func (_e *MockAPI_Expecter) SetTeamIcon(teamID any, data any) *MockAPI_SetTeamIcon_Call {
...
//   - userId string
//   - endtime int64
func (_e *MockAPI_Expecter) SetUserStatusTimedDND(userId any, endtime any) *MockAPI_SetUserStatusTimedDND_Call {
...
func (_e *MockAPI_Expecter) ShareChannel(sc any) *MockAPI_ShareChannel_Call {
...
//   - channelID string
func (_e *MockAPI_Expecter) SyncSharedChannel(channelID any) *MockAPI_SyncSharedChannel_Call {
...
//   - channelID string
//   - remoteID string
func (_e *MockAPI_Expecter) UninviteRemoteFromChannel(channelID any, remoteID any) *MockAPI_UninviteRemoteFromChannel_Call {
...
func (_m *MockAPI) UnregisterChannelGuard(channelID string) *model.AppError {
	ret := _m.Called(channelID)
...
// MockAPI_UnregisterChannelGuard_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'UnregisterChannelGuard'
type MockAPI_UnregisterChannelGuard_Call struct {
	*mock.Call
}

// UnregisterChannelGuard is a helper method to define mock.On call
//   - channelID string
func (_e *MockAPI_Expecter) UnregisterChannelGuard(channelID any) *MockAPI_UnregisterChannelGuard_Call {
	return &MockAPI_UnregisterChannelGuard_Call{Call: _e.mock.On("UnregisterChannelGuard", channelID)}
}

func (_c *MockAPI_UnregisterChannelGuard_Call) Run(run func(channelID string)) *MockAPI_UnregisterChannelGuard_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string))
	})
	return _c
...
func (_c *MockAPI_UnregisterChannelGuard_Call) Return(_a0 *model.AppError) *MockAPI_UnregisterChannelGuard_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockAPI_UnregisterChannelGuard_Call) RunAndReturn(run func(string) *model.AppError) *MockAPI_UnregisterChannelGuard_Call {
	_c.Call.Return(run)
	return _c
}
...
//   - teamID string
//   - trigger string
func (_e *MockAPI_Expecter) UnregisterCommand(teamID any, trigger any) *MockAPI_UnregisterCommand_Call {
...
//   - pluginID string
func (_e *MockAPI_Expecter) UnregisterPluginForSharedChannels(pluginID any) *MockAPI_UnregisterPluginForSharedChannels_Call {
...
func (_m *MockAPI) UnregisterPluginRemoteForSharedChannels(remoteID string) error {
...
// MockAPI_UnregisterPluginRemoteForSharedChannels_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'UnregisterPluginRemoteForSharedChannels'
type MockAPI_UnregisterPluginRemoteForSharedChannels_Call struct {
	*mock.Call
}

// UnregisterPluginRemoteForSharedChannels is a helper method to define mock.On call
//   - remoteID string
func (_e *MockAPI_Expecter) UnregisterPluginRemoteForSharedChannels(remoteID any) *MockAPI_UnregisterPluginRemoteForSharedChannels_Call {
	return &MockAPI_UnregisterPluginRemoteForSharedChannels_Call{Call: _e.mock.On("UnregisterPluginRemoteForSharedChannels", remoteID)}
}

func (_c *MockAPI_UnregisterPluginRemoteForSharedChannels_Call) Run(run func(remoteID string)) *MockAPI_UnregisterPluginRemoteForSharedChannels_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string))
	})
	return _c
...
func (_c *MockAPI_UnregisterPluginRemoteForSharedChannels_Call) Return(_a0 error) *MockAPI_UnregisterPluginRemoteForSharedChannels_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockAPI_UnregisterPluginRemoteForSharedChannels_Call) RunAndReturn(run func(string) error) *MockAPI_UnregisterPluginRemoteForSharedChannels_Call {
	_c.Call.Return(run)
	return _c
}
...
//   - channelID string
func (_e *MockAPI_Expecter) UnshareChannel(channelID any) *MockAPI_UnshareChannel_Call {
...
//   - botUserId string
//   - active bool
func (_e *MockAPI_Expecter) UpdateBotActive(botUserId any, active any) *MockAPI_UpdateBotActive_Call {
...
//   - channel *model.Channel
func (_e *MockAPI_Expecter) UpdateChannel(channel any) *MockAPI_UpdateChannel_Call {
...
func (_e *MockAPI_Expecter) UpdateChannelMemberNotifications(channelId any, userID any, notifications any) *MockAPI_UpdateChannelMemberNotifications_Call {
...
//   - userID string
//   - newRoles string
func (_e *MockAPI_Expecter) UpdateChannelMemberRoles(channelId any, userID any, newRoles any) *MockAPI_UpdateChannelMemberRoles_Call {
...
func (_e *MockAPI_Expecter) UpdateChannelSidebarCategories(userID any, teamID any, categories any) *MockAPI_UpdateChannelSidebarCategories_Call {
...
func (_e *MockAPI_Expecter) UpdateCommand(commandID any, updatedCmd any) *MockAPI_UpdateCommand_Call {
...
//   - userID string
//   - post *model.Post
func (_e *MockAPI_Expecter) UpdateEphemeralPost(userID any, post any) *MockAPI_UpdateEphemeralPost_Call {
...
func (_m *MockAPI) UpdateGroup(group *model.Group) (*model.Group, *model.AppError) {
	ret := _m.Called(group)
...
// MockAPI_UpdateGroup_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'UpdateGroup'
type MockAPI_UpdateGroup_Call struct {
	*mock.Call
}

// UpdateGroup is a helper method to define mock.On call
//   - group *model.Group
func (_e *MockAPI_Expecter) UpdateGroup(group any) *MockAPI_UpdateGroup_Call {
	return &MockAPI_UpdateGroup_Call{Call: _e.mock.On("UpdateGroup", group)}
}

func (_c *MockAPI_UpdateGroup_Call) Run(run func(group *model.Group)) *MockAPI_UpdateGroup_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*model.Group))
	})
	return _c
...
func (_c *MockAPI_UpdateGroup_Call) Return(_a0 *model.Group, _a1 *model.AppError) *MockAPI_UpdateGroup_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockAPI_UpdateGroup_Call) RunAndReturn(run func(*model.Group) (*model.Group, *model.AppError)) *MockAPI_UpdateGroup_Call {
	_c.Call.Return(run)
	return _c
}

// UpdateGroupSyncable provides a mock function with given fields: groupSyncable
func (_m *MockAPI) UpdateGroupSyncable(groupSyncable *model.GroupSyncable) (*model.GroupSyncable, *model.AppError) {
...
// MockAPI_UpdateGroupSyncable_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'UpdateGroupSyncable'
type MockAPI_UpdateGroupSyncable_Call struct {
	*mock.Call
}

// UpdateGroupSyncable is a helper method to define mock.On call
//   - groupSyncable *model.GroupSyncable
func (_e *MockAPI_Expecter) UpdateGroupSyncable(groupSyncable any) *MockAPI_UpdateGroupSyncable_Call {
	return &MockAPI_UpdateGroupSyncable_Call{Call: _e.mock.On("UpdateGroupSyncable", groupSyncable)}
}

func (_c *MockAPI_UpdateGroupSyncable_Call) Run(run func(groupSyncable *model.GroupSyncable)) *MockAPI_UpdateGroupSyncable_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*model.GroupSyncable))
	})
	return _c
}

func (_c *MockAPI_UpdateGroupSyncable_Call) Return(_a0 *model.GroupSyncable, _a1 *model.AppError) *MockAPI_UpdateGroupSyncable_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockAPI_UpdateGroupSyncable_Call) RunAndReturn(run func(*model.GroupSyncable) (*model.GroupSyncable, *model.AppError)) *MockAPI_UpdateGroupSyncable_Call {
	_c.Call.Return(run)
	return _c
}
...
//   - app *model.OAuthApp
func (_e *MockAPI_Expecter) UpdateOAuthApp(app any) *MockAPI_UpdateOAuthApp_Call {
...
//   - post *model.Post
func (_e *MockAPI_Expecter) UpdatePost(post any) *MockAPI_UpdatePost_Call {
...
//   - userID string
//   - preferences []model.Preference
func (_e *MockAPI_Expecter) UpdatePreferencesForUser(userID any, preferences any) *MockAPI_UpdatePreferencesForUser_Call {
...
func (_m *MockAPI) UpdatePropertyField(groupID string, field *model.PropertyField) (*model.PropertyField, error) {
...
// MockAPI_UpdatePropertyField_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'UpdatePropertyField'
type MockAPI_UpdatePropertyField_Call struct {
	*mock.Call
}

// UpdatePropertyField is a helper method to define mock.On call
//   - groupID string
//   - field *model.PropertyField
func (_e *MockAPI_Expecter) UpdatePropertyField(groupID any, field any) *MockAPI_UpdatePropertyField_Call {
	return &MockAPI_UpdatePropertyField_Call{Call: _e.mock.On("UpdatePropertyField", groupID, field)}
}

func (_c *MockAPI_UpdatePropertyField_Call) Run(run func(groupID string, field *model.PropertyField)) *MockAPI_UpdatePropertyField_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string), args[1].(*model.PropertyField))
	})
	return _c
}

func (_c *MockAPI_UpdatePropertyField_Call) Return(_a0 *model.PropertyField, _a1 error) *MockAPI_UpdatePropertyField_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockAPI_UpdatePropertyField_Call) RunAndReturn(run func(string, *model.PropertyField) (*model.PropertyField, error)) *MockAPI_UpdatePropertyField_Call {
	_c.Call.Return(run)
	return _c
}

// UpdatePropertyFields provides a mock function with given fields: groupID, fields
func (_m *MockAPI) UpdatePropertyFields(groupID string, fields []*model.PropertyField) ([]*model.PropertyField, error) {
...
// MockAPI_UpdatePropertyFields_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'UpdatePropertyFields'
type MockAPI_UpdatePropertyFields_Call struct {
	*mock.Call
}

// UpdatePropertyFields is a helper method to define mock.On call
//   - groupID string
//   - fields []*model.PropertyField
func (_e *MockAPI_Expecter) UpdatePropertyFields(groupID any, fields any) *MockAPI_UpdatePropertyFields_Call {
	return &MockAPI_UpdatePropertyFields_Call{Call: _e.mock.On("UpdatePropertyFields", groupID, fields)}
}

func (_c *MockAPI_UpdatePropertyFields_Call) Run(run func(groupID string, fields []*model.PropertyField)) *MockAPI_UpdatePropertyFields_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string), args[1].([]*model.PropertyField))
	})
	return _c
...
func (_c *MockAPI_UpdatePropertyFields_Call) Return(_a0 []*model.PropertyField, _a1 error) *MockAPI_UpdatePropertyFields_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockAPI_UpdatePropertyFields_Call) RunAndReturn(run func(string, []*model.PropertyField) ([]*model.PropertyField, error)) *MockAPI_UpdatePropertyFields_Call {
	_c.Call.Return(run)
	return _c
}

// UpdatePropertyValue provides a mock function with given fields: groupID, value
func (_m *MockAPI) UpdatePropertyValue(groupID string, value *model.PropertyValue) (*model.PropertyValue, error) {
...
// MockAPI_UpdatePropertyValue_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'UpdatePropertyValue'
type MockAPI_UpdatePropertyValue_Call struct {
	*mock.Call
}

// UpdatePropertyValue is a helper method to define mock.On call
//   - groupID string
//   - value *model.PropertyValue
func (_e *MockAPI_Expecter) UpdatePropertyValue(groupID any, value any) *MockAPI_UpdatePropertyValue_Call {
	return &MockAPI_UpdatePropertyValue_Call{Call: _e.mock.On("UpdatePropertyValue", groupID, value)}
}

func (_c *MockAPI_UpdatePropertyValue_Call) Run(run func(groupID string, value *model.PropertyValue)) *MockAPI_UpdatePropertyValue_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string), args[1].(*model.PropertyValue))
	})
	return _c
}

func (_c *MockAPI_UpdatePropertyValue_Call) Return(_a0 *model.PropertyValue, _a1 error) *MockAPI_UpdatePropertyValue_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockAPI_UpdatePropertyValue_Call) RunAndReturn(run func(string, *model.PropertyValue) (*model.PropertyValue, error)) *MockAPI_UpdatePropertyValue_Call {
	_c.Call.Return(run)
	return _c
}

// UpdatePropertyValues provides a mock function with given fields: groupID, values
func (_m *MockAPI) UpdatePropertyValues(groupID string, values []*model.PropertyValue) ([]*model.PropertyValue, error) {
...
// MockAPI_UpdatePropertyValues_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'UpdatePropertyValues'
type MockAPI_UpdatePropertyValues_Call struct {
	*mock.Call
}

// UpdatePropertyValues is a helper method to define mock.On call
//   - groupID string
//   - values []*model.PropertyValue
func (_e *MockAPI_Expecter) UpdatePropertyValues(groupID any, values any) *MockAPI_UpdatePropertyValues_Call {
	return &MockAPI_UpdatePropertyValues_Call{Call: _e.mock.On("UpdatePropertyValues", groupID, values)}
}

func (_c *MockAPI_UpdatePropertyValues_Call) Run(run func(groupID string, values []*model.PropertyValue)) *MockAPI_UpdatePropertyValues_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string), args[1].([]*model.PropertyValue))
	})
	return _c
...
func (_c *MockAPI_UpdatePropertyValues_Call) Return(_a0 []*model.PropertyValue, _a1 error) *MockAPI_UpdatePropertyValues_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockAPI_UpdatePropertyValues_Call) RunAndReturn(run func(string, []*model.PropertyValue) ([]*model.PropertyValue, error)) *MockAPI_UpdatePropertyValues_Call {
	_c.Call.Return(run)
	return _c
}
...
//   - sc *model.SharedChannel
func (_e *MockAPI_Expecter) UpdateSharedChannel(sc any) *MockAPI_UpdateSharedChannel_Call {
...
func (_e *MockAPI_Expecter) UpdateSharedChannelCursor(channelID any, remoteID any, cusror any) *MockAPI_UpdateSharedChannelCursor_Call {
...
//   - team *model.Team
func (_e *MockAPI_Expecter) UpdateTeam(team any) *MockAPI_UpdateTeam_Call {
...
//   - userID string
//   - newRoles string
func (_e *MockAPI_Expecter) UpdateTeamMemberRoles(teamID any, userID any, newRoles any) *MockAPI_UpdateTeamMemberRoles_Call {
...
//   - user *model.User
func (_e *MockAPI_Expecter) UpdateUser(user any) *MockAPI_UpdateUser_Call {
...
//   - userID string
//   - active bool
func (_e *MockAPI_Expecter) UpdateUserActive(userID any, active any) *MockAPI_UpdateUserActive_Call {
...
func (_e *MockAPI_Expecter) UpdateUserAuth(userID any, userAuth any) *MockAPI_UpdateUserAuth_Call {
...
func (_e *MockAPI_Expecter) UpdateUserCustomStatus(userID any, customStatus any) *MockAPI_UpdateUserCustomStatus_Call {
...
//   - userID string
//   - newRoles string
func (_e *MockAPI_Expecter) UpdateUserRoles(userID any, newRoles any) *MockAPI_UpdateUserRoles_Call {
...
//   - userID string
//   - status string
func (_e *MockAPI_Expecter) UpdateUserStatus(userID any, status any) *MockAPI_UpdateUserStatus_Call {
...
//   - us *model.UploadSession
//   - rd io.Reader
func (_e *MockAPI_Expecter) UploadData(us any, rd any) *MockAPI_UploadData_Call {
...
//   - channelId string
//   - filename string
func (_e *MockAPI_Expecter) UploadFile(data any, channelId any, filename any) *MockAPI_UploadFile_Call {
...
func (_m *MockAPI) UpsertGroupMember(groupID string, userID string) (*model.GroupMember, *model.AppError) {
	ret := _m.Called(groupID, userID)
...
// MockAPI_UpsertGroupMember_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'UpsertGroupMember'
type MockAPI_UpsertGroupMember_Call struct {
	*mock.Call
}

// UpsertGroupMember is a helper method to define mock.On call
//   - groupID string
//   - userID string
func (_e *MockAPI_Expecter) UpsertGroupMember(groupID any, userID any) *MockAPI_UpsertGroupMember_Call {
	return &MockAPI_UpsertGroupMember_Call{Call: _e.mock.On("UpsertGroupMember", groupID, userID)}
}

func (_c *MockAPI_UpsertGroupMember_Call) Run(run func(groupID string, userID string)) *MockAPI_UpsertGroupMember_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string), args[1].(string))
	})
	return _c
...
func (_c *MockAPI_UpsertGroupMember_Call) Return(_a0 *model.GroupMember, _a1 *model.AppError) *MockAPI_UpsertGroupMember_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockAPI_UpsertGroupMember_Call) RunAndReturn(run func(string, string) (*model.GroupMember, *model.AppError)) *MockAPI_UpsertGroupMember_Call {
	_c.Call.Return(run)
	return _c
}

// UpsertGroupMembers provides a mock function with given fields: groupID, userIDs
func (_m *MockAPI) UpsertGroupMembers(groupID string, userIDs []string) ([]*model.GroupMember, *model.AppError) {
...
// MockAPI_UpsertGroupMembers_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'UpsertGroupMembers'
type MockAPI_UpsertGroupMembers_Call struct {
	*mock.Call
}

// UpsertGroupMembers is a helper method to define mock.On call
//   - groupID string
//   - userIDs []string
func (_e *MockAPI_Expecter) UpsertGroupMembers(groupID any, userIDs any) *MockAPI_UpsertGroupMembers_Call {
	return &MockAPI_UpsertGroupMembers_Call{Call: _e.mock.On("UpsertGroupMembers", groupID, userIDs)}
}

func (_c *MockAPI_UpsertGroupMembers_Call) Run(run func(groupID string, userIDs []string)) *MockAPI_UpsertGroupMembers_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string), args[1].([]string))
	})
	return _c
...
func (_c *MockAPI_UpsertGroupMembers_Call) Return(_a0 []*model.GroupMember, _a1 *model.AppError) *MockAPI_UpsertGroupMembers_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockAPI_UpsertGroupMembers_Call) RunAndReturn(run func(string, []string) ([]*model.GroupMember, *model.AppError)) *MockAPI_UpsertGroupMembers_Call {
	_c.Call.Return(run)
	return _c
}

// UpsertGroupSyncable provides a mock function with given fields: groupSyncable
func (_m *MockAPI) UpsertGroupSyncable(groupSyncable *model.GroupSyncable) (*model.GroupSyncable, *model.AppError) {
	ret := _m.Called(groupSyncable)
...
// MockAPI_UpsertGroupSyncable_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'UpsertGroupSyncable'
type MockAPI_UpsertGroupSyncable_Call struct {
	*mock.Call
}

// UpsertGroupSyncable is a helper method to define mock.On call
//   - groupSyncable *model.GroupSyncable
func (_e *MockAPI_Expecter) UpsertGroupSyncable(groupSyncable any) *MockAPI_UpsertGroupSyncable_Call {
	return &MockAPI_UpsertGroupSyncable_Call{Call: _e.mock.On("UpsertGroupSyncable", groupSyncable)}
}

func (_c *MockAPI_UpsertGroupSyncable_Call) Run(run func(groupSyncable *model.GroupSyncable)) *MockAPI_UpsertGroupSyncable_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*model.GroupSyncable))
	})
	return _c
...
func (_c *MockAPI_UpsertGroupSyncable_Call) Return(_a0 *model.GroupSyncable, _a1 *model.AppError) *MockAPI_UpsertGroupSyncable_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockAPI_UpsertGroupSyncable_Call) RunAndReturn(run func(*model.GroupSyncable) (*model.GroupSyncable, *model.AppError)) *MockAPI_UpsertGroupSyncable_Call {
	_c.Call.Return(run)
	return _c
}

// UpsertPropertyValue provides a mock function with given fields: value
func (_m *MockAPI) UpsertPropertyValue(value *model.PropertyValue) (*model.PropertyValue, error) {
	ret := _m.Called(value)
...
// MockAPI_UpsertPropertyValue_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'UpsertPropertyValue'
type MockAPI_UpsertPropertyValue_Call struct {
	*mock.Call
}

// UpsertPropertyValue is a helper method to define mock.On call
//   - value *model.PropertyValue
func (_e *MockAPI_Expecter) UpsertPropertyValue(value any) *MockAPI_UpsertPropertyValue_Call {
	return &MockAPI_UpsertPropertyValue_Call{Call: _e.mock.On("UpsertPropertyValue", value)}
}

func (_c *MockAPI_UpsertPropertyValue_Call) Run(run func(value *model.PropertyValue)) *MockAPI_UpsertPropertyValue_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*model.PropertyValue))
	})
	return _c
...
func (_c *MockAPI_UpsertPropertyValue_Call) Return(_a0 *model.PropertyValue, _a1 error) *MockAPI_UpsertPropertyValue_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockAPI_UpsertPropertyValue_Call) RunAndReturn(run func(*model.PropertyValue) (*model.PropertyValue, error)) *MockAPI_UpsertPropertyValue_Call {
	_c.Call.Return(run)
	return _c
}

// UpsertPropertyValues provides a mock function with given fields: values
func (_m *MockAPI) UpsertPropertyValues(values []*model.PropertyValue) ([]*model.PropertyValue, error) {
...
// MockAPI_UpsertPropertyValues_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'UpsertPropertyValues'
type MockAPI_UpsertPropertyValues_Call struct {
	*mock.Call
}

// UpsertPropertyValues is a helper method to define mock.On call
//   - values []*model.PropertyValue
func (_e *MockAPI_Expecter) UpsertPropertyValues(values any) *MockAPI_UpsertPropertyValues_Call {
	return &MockAPI_UpsertPropertyValues_Call{Call: _e.mock.On("UpsertPropertyValues", values)}
}

func (_c *MockAPI_UpsertPropertyValues_Call) Run(run func(values []*model.PropertyValue)) *MockAPI_UpsertPropertyValues_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].([]*model.PropertyValue))
	})
	return _c
...
func (_c *MockAPI_UpsertPropertyValues_Call) Return(_a0 []*model.PropertyValue, _a1 error) *MockAPI_UpsertPropertyValues_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockAPI_UpsertPropertyValues_Call) RunAndReturn(run func([]*model.PropertyValue) ([]*model.PropertyValue, error)) *MockAPI_UpsertPropertyValues_Call {
	_c.Call.Return(run)
	return _c
}
