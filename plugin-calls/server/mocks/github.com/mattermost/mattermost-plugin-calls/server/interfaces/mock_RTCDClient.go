...
//   - callID string
//   - sessionID string
func (_e *MockRTCDClient_Expecter) GetSession(callID any, sessionID any) *MockRTCDClient_GetSession_Call {
...
//   - callID string
func (_e *MockRTCDClient_Expecter) GetSessions(callID any) *MockRTCDClient_GetSessions_Call {
...
func (_e *MockRTCDClient_Expecter) Send(msg any) *MockRTCDClient_Send_Call {
