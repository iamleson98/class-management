...
const LiveCaptionsNumThreadsPerTranscriber = (props: CustomComponentProps) => {
    ...
    const theDefault = manifest.settings_schema?.settings.find((e) => e.key === 'LiveCaptionsNumThreadsPerTranscriber')?.default || '';
    ...
    const value = overridden ? config.LiveCaptionsNumThreadsPerTranscriber : props.value;
