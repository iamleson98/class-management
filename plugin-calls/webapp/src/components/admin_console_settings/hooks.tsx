...
export const useHelptext = (propsHelpText: string | JSX.Element | null) => {
    ...
    const disabledPostfix = formatMessage({defaultMessage: 'Not applicable when the <link>RTCD service URL</link> field is in use.'},
        {link: (text: React.ReactNode) => <a href={'https://mattermost.com/pl/calls-configuration-settings-rtcd-service-url?utm_source=mattermost&utm_medium=in-product&utm_content=calls_admin_settings'}>{text}</a>});
