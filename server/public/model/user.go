...
type User struct {
	...
	AuthData               *string     `json:"v,omitempty"`
	...
	BotLastIconUpdate      int64       `json:"botlasticonupdate,omitempty"`
	TermsOfServiceId       string      `json:"termsofserviceid,omitempty"`
	TermsOfServiceCreateAt int64       `json:"termsofservicecreateat,omitempty"`
	DisableWelcomeEmail    bool        `json:"disablewelcomeemail"`
	LastLogin              int64       `json:"lastlogin,omitempty"`
	MfaUsedTimestamps      StringArray `json:"mfausetimestamps,omitempty"`
...
func (u *User) IsValid() *AppError {
	...
	if u.ParentId != nil && !IsValidId(*u.ParentId) {
		return InvalidUserError("parent_id", u.Id, *u.ParentId)
	}
