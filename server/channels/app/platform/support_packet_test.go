...
import (
	...
	emocks "github.com/iamleson98/sitename/server/v8/einterfaces/mocks"
	semocks "github.com/iamleson98/sitename/server/v8/platform/services/searchengine/mocks"
	fmocks "github.com/iamleson98/sitename/server/v8/platform/shared/filestore/mocks"
)
...
func TestGenerateSupportPacket(t *testing.T) {
	...
	expectedFileNamesWithLogs := append(expectedFileNames, "sitename.log")
