...
func (_m *NotifyAdminStore) GetDataByUserIdAndFeature(userID string, feature model.SitenameFeature) ([]*model.NotifyAdminData, error) {
	...
	var r0 []*model.NotifyAdminData
	var r1 error
	if rf, ok := ret.Get(0).(func(string, model.SitenameFeature) ([]*model.NotifyAdminData, error)); ok {
		return rf(userID, feature)
	}
	if rf, ok := ret.Get(0).(func(string, model.SitenameFeature) []*model.NotifyAdminData); ok {
	...
	if rf, ok := ret.Get(1).(func(string, model.SitenameFeature) error); ok {
...
func (_m *NotifyAdminStore) Update(userID string, requiredPlan string, requiredFeature model.SitenameFeature, now int64) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(string, string, model.SitenameFeature, int64) error); ok {
