...
func (api *API) InitChannel() {
	api.BaseRoutes.Channels.Method(http.MethodGet, "/", api.APISessionRequired(getAllChannels))
	api.BaseRoutes.Channels.Method(http.MethodPost, "/", api.APISessionRequired(createChannel))
	api.BaseRoutes.Channels.Method(http.MethodPost, "/direct", api.APISessionRequired(createDirectChannel))
	api.BaseRoutes.Channels.Method(http.MethodPost, "/search", api.APISessionRequiredDisableWhenBusy(searchAllChannels))
	api.BaseRoutes.Channels.Method(http.MethodPost, "/group/search", api.APISessionRequiredDisableWhenBusy(searchGroupChannels))
	api.BaseRoutes.Channels.Method(http.MethodPost, "/group", api.APISessionRequired(createGroupChannel))
	api.BaseRoutes.Channels.Method(http.MethodPost, "/members/{user_id:[A-Za-z0-9]+}/view", api.APISessionRequired(viewChannel))
	api.BaseRoutes.Channels.Method(http.MethodPost, "/members/{user_id:[A-Za-z0-9]+}/mark_read", api.APISessionRequired(readMultipleChannels))
	api.BaseRoutes.Channels.Method(http.MethodPut, "/{channel_id:[A-Za-z0-9]+}/scheme", api.APISessionRequired(updateChannelScheme))
	api.BaseRoutes.Channels.Method(http.MethodPost, "/stats/member_count", api.APISessionRequired(getChannelsMemberCount))

	api.BaseRoutes.ChannelsForTeam.Method(http.MethodGet, "/", api.APISessionRequired(getPublicChannelsForTeam))
	api.BaseRoutes.ChannelsForTeam.Method(http.MethodGet, "/deleted", api.APISessionRequired(getDeletedChannelsForTeam))
	api.BaseRoutes.ChannelsForTeam.Method(http.MethodGet, "/private", api.APISessionRequired(getPrivateChannelsForTeam))
	api.BaseRoutes.ChannelsForTeam.Method(http.MethodPost, "/ids", api.APISessionRequired(getPublicChannelsByIdsForTeam))
	api.BaseRoutes.ChannelsForTeam.Method(http.MethodPost, "/search", api.APISessionRequiredDisableWhenBusy(searchChannelsForTeam))
	api.BaseRoutes.ChannelsForTeam.Method(http.MethodGet, "/autocomplete", api.APISessionRequired(autocompleteChannelsForTeam))
	api.BaseRoutes.ChannelsForTeam.Method(http.MethodGet, "/search_autocomplete", api.APISessionRequired(autocompleteChannelsForTeamForSearch))
	api.BaseRoutes.User.Method(http.MethodGet, "/teams/{team_id:[A-Za-z0-9]+}/channels", api.APISessionRequired(getChannelsForTeamForUser))
	api.BaseRoutes.User.Method(http.MethodGet, "/channels", api.APISessionRequired(getChannelsForUser))

	api.BaseRoutes.ChannelCategories.Method(http.MethodGet, "/", api.APISessionRequired(getCategoriesForTeamForUser))
	api.BaseRoutes.ChannelCategories.Method(http.MethodPost, "/", api.APISessionRequired(createCategoryForTeamForUser))
	api.BaseRoutes.ChannelCategories.Method(http.MethodPut, "/", api.APISessionRequired(updateCategoriesForTeamForUser))
	api.BaseRoutes.ChannelCategories.Method(http.MethodGet, "/order", api.APISessionRequired(getCategoryOrderForTeamForUser))
	api.BaseRoutes.ChannelCategories.Method(http.MethodPut, "/order", api.APISessionRequired(updateCategoryOrderForTeamForUser))
	api.BaseRoutes.ChannelCategories.Method(http.MethodGet, "/{category_id:[A-Za-z0-9_-]+}", api.APISessionRequired(getCategoryForTeamForUser))
	api.BaseRoutes.ChannelCategories.Method(http.MethodPut, "/{category_id:[A-Za-z0-9_-]+}", api.APISessionRequired(updateCategoryForTeamForUser))
	api.BaseRoutes.ChannelCategories.Method(http.MethodDelete, "/{category_id:[A-Za-z0-9_-]+}", api.APISessionRequired(deleteCategoryForTeamForUser))

	api.BaseRoutes.Channel.Method(http.MethodGet, "/", api.APISessionRequired(getChannel))
	api.BaseRoutes.Channel.Method(http.MethodPut, "/", api.APISessionRequired(updateChannel))
	api.BaseRoutes.Channel.Method(http.MethodPut, "/patch", api.APISessionRequired(patchChannel))
	api.BaseRoutes.Channel.Method(http.MethodPut, "/privacy", api.APISessionRequired(updateChannelPrivacy))
	api.BaseRoutes.Channel.Method(http.MethodPost, "/restore", api.APISessionRequired(restoreChannel))
	api.BaseRoutes.Channel.Method(http.MethodDelete, "/", api.APISessionRequired(deleteChannel))
	api.BaseRoutes.Channel.Method(http.MethodGet, "/stats", api.APISessionRequired(getChannelStats))
	api.BaseRoutes.Channel.Method(http.MethodGet, "/pinned", api.APISessionRequired(getPinnedPosts))
	api.BaseRoutes.Channel.Method(http.MethodGet, "/timezones", api.APISessionRequired(getChannelMembersTimezones))
	api.BaseRoutes.Channel.Method(http.MethodGet, "/members_minus_group_members", api.APISessionRequired(channelMembersMinusGroupMembers))
	api.BaseRoutes.Channel.Method(http.MethodPost, "/move", api.APISessionRequired(moveChannel))
	api.BaseRoutes.Channel.Method(http.MethodGet, "/member_counts_by_group", api.APISessionRequired(channelMemberCountsByGroup))
	api.BaseRoutes.Channel.Method(http.MethodGet, "/common_teams", api.APISessionRequired(getDirectOrGroupMessageMembersCommonTeams))
	api.BaseRoutes.Channel.Method(http.MethodPost, "/convert_to_channel", api.APISessionRequired(convertGroupMessageToChannel))
	api.BaseRoutes.Channel.Method(http.MethodGet, "/access_control/attributes", api.APISessionRequired(getChannelAccessControlAttributes))

	api.BaseRoutes.ChannelForUser.Method(http.MethodGet, "/unread", api.APISessionRequired(getChannelUnread))

	api.BaseRoutes.ChannelByName.Method(http.MethodGet, "/", api.APISessionRequired(getChannelByName))
	api.BaseRoutes.ChannelByNameForTeamName.Method(http.MethodGet, "/", api.APISessionRequired(getChannelByNameForTeamName))

	api.BaseRoutes.ChannelMembers.Method(http.MethodGet, "/", api.APISessionRequired(getChannelMembers))
	api.BaseRoutes.ChannelMembers.Method(http.MethodPost, "/ids", api.APISessionRequired(getChannelMembersByIds))
	api.BaseRoutes.ChannelMembers.Method(http.MethodPost, "/", api.APISessionRequired(addChannelMember))
	api.BaseRoutes.ChannelMembersForUser.Method(http.MethodGet, "/", api.APISessionRequired(getChannelMembersForTeamForUser))
	api.BaseRoutes.ChannelMember.Method(http.MethodGet, "/", api.APISessionRequired(getChannelMember))
	api.BaseRoutes.ChannelMember.Method(http.MethodDelete, "/", api.APISessionRequired(removeChannelMember))
	api.BaseRoutes.ChannelMember.Method(http.MethodPut, "/roles", api.APISessionRequired(updateChannelMemberRoles))
	api.BaseRoutes.ChannelMember.Method(http.MethodPut, "/schemeRoles", api.APISessionRequired(updateChannelMemberSchemeRoles))
	api.BaseRoutes.ChannelMember.Method(http.MethodPut, "/notify_props", api.APISessionRequired(updateChannelMemberNotifyProps))
	api.BaseRoutes.ChannelMember.Method(http.MethodPut, "/autotranslation", api.APISessionRequired(updateChannelMemberAutotranslation))

	api.BaseRoutes.ChannelModerations.Method(http.MethodGet, "/", api.APISessionRequired(getChannelModerations))
	api.BaseRoutes.ChannelModerations.Method(http.MethodPut, "/patch", api.APISessionRequired(patchChannelModerations))
}
...
func updateChannel(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	case model.ChannelTypeOpen:
		if ok, _ := c.App.SessionHasPermissionToChannel(c.AppContext, *c.AppContext.Session(), channelIdStr, model.PermissionManagePublicChannelProperties); !ok {
			c.SetPermissionError(model.PermissionManagePublicChannelProperties)
			return
		}

	case model.ChannelTypePrivate:
		if ok, _ := c.App.SessionHasPermissionToChannel(c.AppContext, *c.AppContext.Session(), channelIdStr, model.PermissionManagePrivateChannelProperties); !ok {
...
func updateChannelPrivacy(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	if model.ChannelType(privacy) == model.ChannelTypeOpen {
		if ok, _ := c.App.SessionHasPermissionToChannel(c.AppContext, *c.AppContext.Session(), channelIdStr, model.PermissionConvertPrivateChannelToPublic); !ok {
	...
	if model.ChannelType(privacy) == model.ChannelTypePrivate {
		if ok, _ := c.App.SessionHasPermissionToChannel(c.AppContext, *c.AppContext.Session(), channelIdStr, model.PermissionConvertPublicChannelToPrivate); !ok {
...
func patchChannel(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	case model.ChannelTypeOpen:
		...
		if updatingAutoTranslation {
			if ok, _ := c.App.SessionHasPermissionToChannel(c.AppContext, *c.AppContext.Session(), channelIdStr, model.PermissionManagePublicChannelAutoTranslation); !ok {
	...
	case model.ChannelTypePrivate:
		...
		if updatingAutoTranslation {
			if ok, _ := c.App.SessionHasPermissionToChannel(c.AppContext, *c.AppContext.Session(), channelIdStr, model.PermissionManagePrivateChannelAutoTranslation); !ok {
	...
	case model.ChannelTypeGroup, model.ChannelTypeDirect:
		// Modifying the header is not linked to any specific permission for group/dm channels, so just check for membership.
		if _, appErr = c.App.GetChannelMember(c.AppContext, channelIdStr, c.AppContext.Session().UserId); appErr != nil {
...
func getChannel(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	if !isContentReviewer {
		...
		} else if ok, _ := c.App.SessionHasPermissionToChannel(c.AppContext, *c.AppContext.Session(), channelIdStr, model.PermissionReadChannel); !ok {
			c.SetPermissionError(model.PermissionReadChannel)
			return
		}
	}
...
func getChannelUnread(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	channelUnread, err := c.App.GetChannelUnread(c.AppContext, channelIdStr, userIdStr)
	if err != nil {
		c.Err = err
		return
	}
...
func getChannelStats(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	memberCount, err := c.App.GetChannelMemberCount(c.AppContext, channelIdStr)
	if err != nil {
		c.Err = err
		return
	}

	guestCount, err := c.App.GetChannelGuestCount(c.AppContext, channelIdStr)
	if err != nil {
		c.Err = err
		return
	}

	pinnedPostCount, err := c.App.GetChannelPinnedPostCount(c.AppContext, channelIdStr)
	if err != nil {
		c.Err = err
		return
	}
	...
	if !excludeFilesCountBool {
		filesCount, err = c.App.GetChannelFileCount(c.AppContext, channelIdStr)
		if err != nil {
			c.Err = err
			return
		}
...
func getPinnedPosts(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	posts, err := c.App.GetPinnedPosts(c.AppContext, channelIdStr)
	if err != nil {
		c.Err = err
		return
	}
...
func getAllChannels(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	if excludeAccessControlPolicyEnforcedBool && !c.App.SessionHasPermissionTo(*c.AppContext.Session(), model.PermissionManageSystem) {
		c.SetPermissionError(model.PermissionManageSystem)
		return
	}

	opts := model.ChannelSearchOpts{
		NotAssociatedToGroup:               c.Params["not_associated_to_group"].(string),
		ExcludeDefaultChannels:             c.Params["exclude_default_channels"].(bool),
		IncludeDeleted:                     c.Params["include_deleted"].(bool),
		ExcludePolicyConstrained:           excludePolicyConstrainedBool,
		AccessControlPolicyEnforced:        c.Params["access_control_policy_enforced"].(bool),
		ExcludeAccessControlPolicyEnforced: excludeAccessControlPolicyEnforcedBool,
	}
	...
	channels, err := c.App.GetAllChannels(c.AppContext, pageInt, perPageInt, opts)
	if err != nil {
		c.Err = err
		return
	}
...
func getPublicChannelsForTeam(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	channels, err := c.App.GetPublicChannelsForTeam(c.AppContext, teamIdStr, (pageInt * perPageInt), perPageInt)
	if err != nil {
		c.Err = err
		return
	}
...
func getDeletedChannelsForTeam(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	channels, err := c.App.GetDeletedChannels(c.AppContext, teamIdStr, (pageInt * perPageInt), perPageInt, c.AppContext.Session().UserId, skipTeamMembershipCheck)
	if err != nil {
		c.Err = err
		return
	}
...
func getPrivateChannelsForTeam(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	channels, err := c.App.GetPrivateChannelsForTeam(c.AppContext, teamIdStr, (pageInt * perPageInt), perPageInt)
	if err != nil {
		c.Err = err
		return
	}
...
func getPublicChannelsByIdsForTeam(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	channels, appErr := c.App.GetPublicChannelsByIdsForTeam(c.AppContext, teamIdStr, channelIds)
	if appErr != nil {
		c.Err = appErr
		return
	}
...
func getChannelsForTeamForUser(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	channels, err := c.App.GetChannelsForTeamForUser(c.AppContext, teamIdStr, userIdStr, &model.ChannelSearchOpts{
...
func getChannelsForUser(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	for {
		channels, err := c.App.GetChannelsForUser(c.AppContext, userIdStr, includeDeletedBool, lastDeleteAt, pageSize, fromChannelID)
		if err != nil {
...
func autocompleteChannelsForTeam(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	channels, err := c.App.AutocompleteChannelsForTeam(c.AppContext, teamIdStr, c.AppContext.Session().UserId, name)
	if err != nil {
		c.Err = err
		return
	}
...
func autocompleteChannelsForTeamForSearch(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	channels, err := c.App.AutocompleteChannelsForSearch(c.AppContext, teamIdStr, c.AppContext.Session().UserId, name)
	if err != nil {
		c.Err = err
		return
	}
...
func searchChannelsForTeam(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	if c.App.SessionHasPermissionToTeam(*c.AppContext.Session(), teamIdStr, model.PermissionListTeamChannels) {
		channels, appErr = c.App.SearchChannels(c.AppContext, teamIdStr, props.Term)
	} else {
		// If the user is not a team member, return a 404
		if _, appErr = c.App.GetTeamMember(c.AppContext, teamIdStr, c.AppContext.Session().UserId); appErr != nil {
			c.Err = appErr
			return
		}

		channels, appErr = c.App.SearchChannelsForUser(c.AppContext, c.AppContext.Session().UserId, teamIdStr, props.Term)
	}
...
func deleteChannel(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	model.AddEventParameterToAuditRec(auditRec, "id", channelIdStr)
	auditRec.AddEventPriorState(channel)
	defer c.LogAuditRec(auditRec)
	...
	if permanentBool {
		if *c.App.Config().ServiceSettings.EnableAPIChannelDeletion {
			...
			if usrErr == nil && user != nil && user.IsSystemAdmin() {
				...
				err = model.NewAppError("deleteChannel", "api.user.delete_channel.not_enabled.for_admin.app_error", nil, "channelId="+channelIdStr, http.StatusUnauthorized)
			} else {
				err = model.NewAppError("deleteChannel", "api.user.delete_channel.not_enabled.app_error", nil, "channelId="+channelIdStr, http.StatusUnauthorized)
			}
		}
	} else {
...
func getChannelMembers(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	members, err := c.App.GetChannelMembersPage(c.AppContext, channelIdStr, pageInt, perPageInt)
	if err != nil {
		c.Err = err
		return
	}
...
func getChannelMembersTimezones(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	membersTimezones, err := c.App.GetChannelMembersTimezones(c.AppContext, channelIdStr)
	if err != nil {
		c.Err = err
		return
	}
...
func getChannelMembersByIds(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	members, appErr := c.App.GetChannelMembersByIds(c.AppContext, channelIdStr, userIds)
	if appErr != nil {
		c.Err = appErr
		return
	}
...
func getChannelMember(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	member, err := c.App.GetChannelMember(c.AppContext, channelIdStr, userIdStr)
	if err != nil {
		c.Err = err
		return
	}
...
func getChannelMembersForTeamForUser(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	if c.AppContext.Session().UserId != userIdStr && !c.App.SessionHasPermissionToTeam(*c.AppContext.Session(), teamIdStr, model.PermissionManageSystem) {
		c.SetPermissionError(model.PermissionManageSystem)
		return
	}

	members, err := c.App.GetChannelMembersForUser(c.AppContext, teamIdStr, userIdStr)
	if err != nil {
		c.Err = err
		return
	}
...
func viewChannel(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	times, err := c.App.ViewChannel(c.AppContext, &view, userIdStr, c.AppContext.Session().Id, view.CollapsedThreadsSupported)
	if err != nil {
		c.Err = err
		return
	}
...
func readMultipleChannels(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	times, appErr := c.App.MarkChannelsAsViewed(c.AppContext, channelIds, userIdStr, c.AppContext.Session().Id, true, c.App.IsCRTEnabledForUser(c.AppContext, userIdStr))
	if appErr != nil {
		c.Err = appErr
		return
	}
...
func updateChannelMemberRoles(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	if ok, _ := c.App.SessionHasPermissionToChannel(c.AppContext, *c.AppContext.Session(), channelIdStr, model.PermissionManageChannelRoles); !ok {
		c.SetPermissionError(model.PermissionManageChannelRoles)
		return
	}

	if _, err := c.App.UpdateChannelMemberRoles(c.AppContext, channelIdStr, userIdStr, newRoles); err != nil {
		c.Err = err
		return
	}
...
func updateChannelMemberSchemeRoles(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	if _, err := c.App.UpdateChannelMemberSchemeRoles(c.AppContext, channelIdStr, userIdStr, schemeRoles.SchemeGuest, schemeRoles.SchemeUser, schemeRoles.SchemeAdmin); err != nil {
		c.Err = err
		return
	}
...
func updateChannelMemberNotifyProps(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	_, err := c.App.UpdateChannelMemberNotifyProps(c.AppContext, props, channelIdStr, userIdStr)
	if err != nil {
		c.Err = err
		return
	}
...
func updateChannelMemberAutotranslation(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	_, err := c.App.GetChannelMember(c.AppContext, channelIdStr, userIdStr)
	if err != nil {
		c.Err = err
		return
	}

	channelEnabled, err := c.App.AutoTranslation().IsChannelEnabled(channelIdStr)
	if err != nil {
		c.Err = err
		return
	}
	...
	_, appErr := c.App.UpdateChannelMemberAutotranslation(c.AppContext, channelIdStr, userIdStr, props.AutoTranslationDisabled)
	if appErr != nil {
		c.Err = appErr
		return
	}
...
func addChannelMember(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	if ok && postRootId != "" {
		...
		if rootPost.ChannelId != channelIdStr {
			c.SetInvalidParam("post_root_id")
			return
		}
	} else if !ok {
	...
	if c.AppContext.Session().IsGuest() {
		if hasPermission, _ := c.App.SessionHasPermissionToChannel(c.AppContext, *c.AppContext.Session(), channelIdStr, model.PermissionReadChannel); !hasPermission {
			c.SetPermissionError(model.PermissionReadChannel)
			return
		}
...
func removeChannelMember(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	if channel.IsGroupConstrained() && (userIdStr != c.AppContext.Session().UserId) && !user.IsBot {
	...
	if userIdStr != c.AppContext.Session().UserId {
		if channel.Type == model.ChannelTypeOpen {
	...
	if err = c.App.RemoveUserFromChannel(c.AppContext, userIdStr, c.AppContext.Session().UserId, channel); err != nil {
		c.Err = err
		return
	}
...
func channelMembersMinusGroupMembers(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	groupIDs := []string{}
	for gid := range strings.SplitSeq(groupIDsParam, ",") {
...
func channelMemberCountsByGroup(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	channelMemberCounts, appErr := c.App.GetMemberCountsByGroup(c.AppContext.With(app.RequestContextWithMaster), channelIdStr, includeTimezones)
	if appErr != nil {
		c.Err = appErr
		return
	}
...
func getDirectOrGroupMessageMembersCommonTeams(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	teams, appErr := c.App.GetDirectOrGroupMessageMembersCommonTeamsAsUser(c.AppContext, channelIdStr)
	if appErr != nil {
		c.Err = appErr
		return
	}
...
func convertGroupMessageToChannel(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	if gmConversionRequest.ChannelID != channelIdStr {
		c.SetInvalidParam("channel_id")
		return
	}
...
func canEditChannelBanner(c *Context, originalChannel *model.Channel) {
	...
	case model.ChannelTypePrivate:
		if ok, _ := c.App.SessionHasPermissionToChannel(c.AppContext, *c.AppContext.Session(), c.Params["channel_id"].(string), model.PermissionManagePrivateChannelBanner); !ok {
			c.SetPermissionError(model.PermissionManagePrivateChannelBanner)
			return
		}
	case model.ChannelTypeOpen:
		if ok, _ := c.App.SessionHasPermissionToChannel(c.AppContext, *c.AppContext.Session(), c.Params["channel_id"].(string), model.PermissionManagePublicChannelBanner); !ok {
...
func getChannelAccessControlAttributes(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	attributes, err := c.App.GetAccessControlPolicyAttributes(c.AppContext, channelIdStr, "*")
	if err != nil {
		c.Err = err
		return
	}
