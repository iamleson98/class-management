...
func (api *API) InitReports() {
	api.BaseRoutes.Reports.Method(http.MethodGet, "/users", api.APISessionRequired(getUsersForReporting))
	api.BaseRoutes.Reports.Method(http.MethodGet, "/users/count", api.APISessionRequired(getUserCountForReporting))
	api.BaseRoutes.Reports.Method(http.MethodPost, "/users/export", api.APISessionRequired(startUsersBatchExport))
	api.BaseRoutes.Reports.Method(http.MethodPost, "/posts", api.APISessionRequired(getPostsForReporting))
}
