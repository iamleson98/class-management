...
func (api *API) InitConfig() {
	api.BaseRoutes.APIRoot.Method(http.MethodGet, "/config", api.APISessionRequired(getConfig))
	api.BaseRoutes.APIRoot.Method(http.MethodPut, "/config", api.APISessionRequired(updateConfig))
	api.BaseRoutes.APIRoot.Method(http.MethodPut, "/config/patch", api.APISessionRequired(patchConfig))
	api.BaseRoutes.APIRoot.Method(http.MethodPost, "/config/reload", api.APISessionRequired(configReload))
	api.BaseRoutes.APIRoot.Method(http.MethodGet, "/config/client", api.APIHandler(getClientConfig))
	api.BaseRoutes.APIRoot.Method(http.MethodGet, "/config/environment", api.APISessionRequired(getEnvironmentConfig))
}
