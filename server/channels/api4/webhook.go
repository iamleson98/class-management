...
func (api *API) InitWebhook() {
	api.BaseRoutes.IncomingHooks.Method(http.MethodPost, "/", api.APISessionRequired(createIncomingHook))
	api.BaseRoutes.IncomingHooks.Method(http.MethodGet, "/", api.APISessionRequired(getIncomingHooks))
	api.BaseRoutes.IncomingHook.Method(http.MethodGet, "/", api.APISessionRequired(getIncomingHook))
	api.BaseRoutes.IncomingHook.Method(http.MethodPut, "/", api.APISessionRequired(updateIncomingHook))
	api.BaseRoutes.IncomingHook.Method(http.MethodDelete, "/", api.APISessionRequired(deleteIncomingHook))
	api.BaseRoutes.OutgoingHooks.Method(http.MethodPost, "/", api.APISessionRequired(createOutgoingHook))
	api.BaseRoutes.OutgoingHooks.Method(http.MethodGet, "/", api.APISessionRequired(getOutgoingHooks))
	api.BaseRoutes.OutgoingHook.Method(http.MethodGet, "/", api.APISessionRequired(getOutgoingHook))
	api.BaseRoutes.OutgoingHook.Method(http.MethodPut, "/", api.APISessionRequired(updateOutgoingHook))
	api.BaseRoutes.OutgoingHook.Method(http.MethodDelete, "/", api.APISessionRequired(deleteOutgoingHook))
	api.BaseRoutes.OutgoingHook.Method(http.MethodPost, "/regen_token", api.APISessionRequired(regenOutgoingHookToken))
}
...
func updateIncomingHook(c *Context, w http.ResponseWriter, r *http.Request) {
	hookId := c.RequireParam("hook_id", web.RequireValidId)
	if c.Err != nil {
		return
	}
...
func getIncomingHooks(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	if teamID != "" {
		...
		hooks, appErr = c.App.GetIncomingWebhooksForTeamPageByUser(teamID, userID, c.Params["page"].(int), c.Params["per_page"].(int))
	} else {
		...
		hooks, appErr = c.App.GetIncomingWebhooksPageByUser(userID, c.Params["page"].(int), c.Params["per_page"].(int))
	}
...
func getOutgoingHooks(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	if channelID != "" {
		...
		hooks, appErr = c.App.GetOutgoingWebhooksForChannelPageByUser(channelID, userID, c.Params["page"].(int), c.Params["per_page"].(int))
	} else if teamID != "" {
		...
		hooks, appErr = c.App.GetOutgoingWebhooksForTeamPageByUser(teamID, userID, c.Params["page"].(int), c.Params["per_page"].(int))
	} else {
		...
		hooks, appErr = c.App.GetOutgoingWebhooksPageByUser(userID, c.Params["page"].(int), c.Params["per_page"].(int))
	}
