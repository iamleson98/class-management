...
func (api *API) InitConfigLocal() {
	api.BaseRoutes.APIRoot.Method(http.MethodGet, "/config", api.APILocal(localGetConfig))
	api.BaseRoutes.APIRoot.Method(http.MethodPut, "/config", api.APILocal(localUpdateConfig))
	api.BaseRoutes.APIRoot.Method(http.MethodPut, "/config/patch", api.APILocal(localPatchConfig))
	api.BaseRoutes.APIRoot.Method(http.MethodPost, "/config/reload", api.APILocal(configReload))
	api.BaseRoutes.APIRoot.Method(http.MethodPost, "/config/migrate", api.APILocal(localMigrateConfig))
	api.BaseRoutes.APIRoot.Method(http.MethodGet, "/config/client", api.APILocal(localGetClientConfig))
}
