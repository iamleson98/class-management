...
func (api *API) InitSaml() {
	api.BaseRoutes.SAML.Method(http.MethodGet, "/metadata", api.APIHandler(getSamlMetadata))
	api.BaseRoutes.SAML.Method(http.MethodPost, "/certificate/public", api.APISessionRequired(addSamlPublicCertificate))
	api.BaseRoutes.SAML.Method(http.MethodPost, "/certificate/private", api.APISessionRequired(addSamlPrivateCertificate))
	api.BaseRoutes.SAML.Method(http.MethodPost, "/certificate/idp", api.APISessionRequired(addSamlIdpCertificate))
	api.BaseRoutes.SAML.Method(http.MethodDelete, "/certificate/public", api.APISessionRequired(removeSamlPublicCertificate))
	api.BaseRoutes.SAML.Method(http.MethodDelete, "/certificate/private", api.APISessionRequired(removeSamlPrivateCertificate))
	api.BaseRoutes.SAML.Method(http.MethodDelete, "/certificate/idp", api.APISessionRequired(removeSamlIdpCertificate))
	api.BaseRoutes.SAML.Method(http.MethodGet, "/certificate/status", api.APISessionRequired(getSamlCertificateStatus))
	api.BaseRoutes.SAML.Method(http.MethodPost, "/metadatafromidp", api.APIHandler(getSamlMetadataFromIdp))
	api.BaseRoutes.SAML.Method(http.MethodPost, "/reset_auth_data", api.APISessionRequired(resetAuthDataToEmail))
}

func (api *API) InitSamlLocal() {
	api.BaseRoutes.SAML.Method(http.MethodPost, "/reset_auth_data", api.APILocal(resetAuthDataToEmail))
}
