...
func (api *API) InitElasticsearch() {
	api.BaseRoutes.Elasticsearch.Method(http.MethodPost, "/test", api.APISessionRequired(testElasticsearch))
	api.BaseRoutes.Elasticsearch.Method(http.MethodPost, "/purge_indexes", api.APISessionRequired(purgeElasticsearchIndexes))
}
