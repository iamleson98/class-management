...
import (
	...
	"github.com/iamleson98/sitename/server/v8/channels/app/email"
...
func (api *API) InitUser() {
	api.BaseRoutes.Users.Method(http.MethodPost, "/", api.APIHandler(createUser))
	api.BaseRoutes.Users.Method(http.MethodGet, "/", api.APISessionRequired(getUsers))
	api.BaseRoutes.Users.Method(http.MethodPost, "/ids", api.APISessionRequired(getUsersByIds))
	api.BaseRoutes.Users.Method(http.MethodPost, "/usernames", api.APISessionRequired(getUsersByNames))
	api.BaseRoutes.Users.Method(http.MethodGet, "/known", api.APISessionRequired(getKnownUsers))
	api.BaseRoutes.Users.Method(http.MethodPost, "/search", api.APISessionRequiredDisableWhenBusy(searchUsers))
	api.BaseRoutes.Users.Method(http.MethodPost, "/search2", api.APISessionRequiredDisableWhenBusy(searchUsers2)) // advanced search
	api.BaseRoutes.Users.Method(http.MethodGet, "/autocomplete", api.APISessionRequired(autocompleteUsers))
	api.BaseRoutes.Users.Method(http.MethodGet, "/stats", api.APISessionRequired(getTotalUsersStats))
	api.BaseRoutes.Users.Method(http.MethodGet, "/stats/filtered", api.APISessionRequired(getFilteredUsersStats))
	api.BaseRoutes.Users.Method(http.MethodPost, "/group_channels", api.APISessionRequired(getUsersByGroupChannelIds))

	api.BaseRoutes.User.Method(http.MethodGet, "/", api.APISessionRequired(getUser))
	api.BaseRoutes.User.Method(http.MethodGet, "/image/default", api.APISessionRequiredTrustRequester(getDefaultProfileImage))
	api.BaseRoutes.User.Method(http.MethodGet, "/image", api.APISessionRequiredTrustRequester(getProfileImage))
	api.BaseRoutes.User.Method(http.MethodPost, "/image", api.APISessionRequired(setProfileImage, handlerParamFileAPI))
	api.BaseRoutes.User.Method(http.MethodDelete, "/image", api.APISessionRequired(setDefaultProfileImage))
	api.BaseRoutes.User.Method(http.MethodPut, "/", api.APISessionRequired(updateUser))
	api.BaseRoutes.User.Method(http.MethodPut, "/patch", api.APISessionRequired(patchUser))
	api.BaseRoutes.User.Method(http.MethodDelete, "/", api.APISessionRequired(deleteUser))
	api.BaseRoutes.User.Method(http.MethodPut, "/roles", api.APISessionRequired(updateUserRoles))
	api.BaseRoutes.User.Method(http.MethodPut, "/active", api.APISessionRequired(updateUserActive))
	api.BaseRoutes.User.Method(http.MethodPut, "/password", api.APISessionRequired(updatePassword))
	api.BaseRoutes.User.Method(http.MethodPost, "/promote", api.APISessionRequired(promoteGuestToUser))
	api.BaseRoutes.User.Method(http.MethodPost, "/demote", api.APISessionRequired(demoteUserToGuest))
	api.BaseRoutes.User.Method(http.MethodPost, "/convert_to_bot", api.APISessionRequired(convertUserToBot))
	api.BaseRoutes.Users.Method(http.MethodPost, "/password/reset", api.APIHandler(resetPassword))
	api.BaseRoutes.Users.Method(http.MethodPost, "/password/reset/send", api.APIHandler(sendPasswordReset))
	api.BaseRoutes.Users.Method(http.MethodPost, "/email/verify", api.APIHandler(verifyUserEmail))
	api.BaseRoutes.Users.Method(http.MethodPost, "/email/verify/send", api.APIHandler(sendVerificationEmail))
	api.BaseRoutes.User.Method(http.MethodPost, "/email/verify/member", api.APISessionRequired(verifyUserEmailWithoutToken))
	api.BaseRoutes.User.Method(http.MethodPost, "/terms_of_service", api.APISessionRequired(saveUserTermsOfService))
	api.BaseRoutes.User.Method(http.MethodGet, "/terms_of_service", api.APISessionRequired(getUserTermsOfService))
	api.BaseRoutes.User.Method(http.MethodPost, "/reset_failed_attempts", api.APISessionRequired(resetPasswordFailedAttempts))

	api.BaseRoutes.User.Method(http.MethodPut, "/auth", api.APISessionRequiredTrustRequester(updateUserAuth))

	api.BaseRoutes.User.Method(http.MethodPut, "/mfa", api.APISessionRequiredMfa(updateUserMfa))
	api.BaseRoutes.User.Method(http.MethodPost, "/mfa/generate", api.APISessionRequiredMfa(generateMfaSecret))

	api.BaseRoutes.Users.Method(http.MethodPost, "/login", api.APIHandler(login))
	api.BaseRoutes.Users.Method(http.MethodPost, "/login/sso/code-exchange", api.APIHandler(loginSSOCodeExchange))
	api.BaseRoutes.Users.Method(http.MethodPost, "/login/desktop_token", api.RateLimitedHandler(api.APIHandler(loginWithDesktopToken), model.RateLimitSettings{PerSec: model.NewPointer(2), MaxBurst: model.NewPointer(1)}))
	api.BaseRoutes.Users.Method(http.MethodPost, "/login/switch", api.APIHandler(switchAccountType))
	api.BaseRoutes.Users.Method(http.MethodPost, "/login/cws", api.APIHandlerTrustRequester(loginCWS))
	api.BaseRoutes.Users.Method(http.MethodPost, "/login/type", api.APIHandler(getLoginType))
	api.BaseRoutes.Users.Method(http.MethodPost, "/logout", api.APIHandler(logout))

	api.BaseRoutes.UserByUsername.Method(http.MethodGet, "/", api.APISessionRequired(getUserByUsername))
	api.BaseRoutes.UserByEmail.Method(http.MethodGet, "/", api.APISessionRequired(getUserByEmail))

	api.BaseRoutes.User.Method(http.MethodGet, "/sessions", api.APISessionRequired(getSessions))
	api.BaseRoutes.User.Method(http.MethodPost, "/sessions/revoke", api.APISessionRequired(revokeSession))
	api.BaseRoutes.User.Method(http.MethodPost, "/sessions/revoke/all", api.APISessionRequired(revokeAllSessionsForUser))
	api.BaseRoutes.Users.Method(http.MethodPost, "/sessions/revoke/all", api.APISessionRequired(revokeAllSessionsAllUsers))
	api.BaseRoutes.Users.Method(http.MethodPut, "/sessions/device", api.APISessionRequired(handleDeviceProps))
	api.BaseRoutes.User.Method(http.MethodGet, "/audits", api.APISessionRequired(getUserAudits))

	api.BaseRoutes.User.Method(http.MethodPost, "/tokens", api.APISessionRequired(createUserAccessToken))
	api.BaseRoutes.User.Method(http.MethodGet, "/tokens", api.APISessionRequired(getUserAccessTokensForUser))
	api.BaseRoutes.Users.Method(http.MethodGet, "/tokens", api.APISessionRequired(getUserAccessTokens))
	api.BaseRoutes.Users.Method(http.MethodPost, "/tokens/search", api.APISessionRequired(searchUserAccessTokens))
	api.BaseRoutes.Users.Method(http.MethodGet, "/tokens/{token_id:[A-Za-z0-9]+}", api.APISessionRequired(getUserAccessToken))
	api.BaseRoutes.Users.Method(http.MethodPost, "/tokens/revoke", api.APISessionRequired(revokeUserAccessToken))
	api.BaseRoutes.Users.Method(http.MethodPost, "/tokens/disable", api.APISessionRequired(disableUserAccessToken))
	api.BaseRoutes.Users.Method(http.MethodPost, "/tokens/enable", api.APISessionRequired(enableUserAccessToken))

	api.BaseRoutes.User.Method(http.MethodPost, "/typing", api.APISessionRequiredDisableWhenBusy(publishUserTyping))

	api.BaseRoutes.Users.Method(http.MethodPost, "/migrate_auth/ldap", api.APISessionRequired(migrateAuthToLDAP))
	api.BaseRoutes.Users.Method(http.MethodPost, "/migrate_auth/saml", api.APISessionRequired(migrateAuthToSaml))

	api.BaseRoutes.User.Method(http.MethodGet, "/uploads", api.APISessionRequired(getUploadsForUser))
	api.BaseRoutes.User.Method(http.MethodGet, "/channel_members", api.APISessionRequired(getChannelMembersForUser))

	api.BaseRoutes.Users.Method(http.MethodGet, "/invalid_emails", api.APISessionRequired(getUsersWithInvalidEmails))

	api.BaseRoutes.UserThreads.Method(http.MethodGet, "/", api.APISessionRequired(getThreadsForUser))
	api.BaseRoutes.UserThreads.Method(http.MethodPut, "/read", api.APISessionRequired(updateReadStateAllThreadsByUser))

	api.BaseRoutes.UserThread.Method(http.MethodGet, "/", api.APISessionRequired(getThreadForUser))
	api.BaseRoutes.UserThread.Method(http.MethodPut, "/following", api.APISessionRequired(followThreadByUser))
	api.BaseRoutes.UserThread.Method(http.MethodDelete, "/following", api.APISessionRequired(unfollowThreadByUser))
	api.BaseRoutes.UserThread.Method(http.MethodPut, "/read/{timestamp:[0-9]+}", api.APISessionRequired(updateReadStateThreadByUser))
	api.BaseRoutes.UserThread.Method(http.MethodPost, "/set_unread/{post_id:[A-Za-z0-9]+}", api.APISessionRequired(setUnreadThreadByPostId))

	api.BaseRoutes.Users.Method(http.MethodPost, "/notify-admin", api.APISessionRequired(handleNotifyAdmin))
	api.BaseRoutes.Users.Method(http.MethodPost, "/trigger-notify-admin-posts", api.APISessionRequired(handleTriggerNotifyAdminPosts))
}
...
func getUser(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	canSee, err := c.App.UserCanSeeOtherUser(c.AppContext, c.AppContext.Session().UserId, userIdStr)
	if err != nil {
...
func setProfileImage(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	if !c.App.SessionHasPermissionToUserOrBot(c.AppContext, *c.AppContext.Session(), userIdStr) {
...
func getUsers(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	if withoutTeamBool, _ := strconv.ParseBool(withoutTeam); withoutTeamBool {
		...
		if ok, _ := c.App.ChannelAccessControlled(c.AppContext, notInChannelId); ok {
			...
			profiles, appErr = c.App.GetUsersNotInAbacChannel(c.AppContext, inTeamId, notInChannelId, groupConstrainedBool, cursorId, c.Params["per_page"].(int), c.IsSystemAdmin(), restrictions)
		} else {
			profiles, appErr = c.App.GetUsersNotInChannelPage(inTeamId, notInChannelId, groupConstrainedBool, c.Params["page"].(int), c.Params["per_page"].(int), c.IsSystemAdmin(), restrictions)
		}
	} else if notInTeamId != "" {
		...
		profiles, appErr = c.App.GetUsersNotInTeamPage(notInTeamId, groupConstrainedBool, c.Params["page"].(int), c.Params["per_page"].(int), c.IsSystemAdmin(), restrictions)
	} else if inTeamId != "" {
		...
		if sort == "display_name" {
			...
			profiles, _, appErr = c.App.GetGroupMemberUsersSortedPage(inGroupId, c.Params["page"].(int), c.Params["per_page"].(int), userGetOptions.ViewRestrictions, c.App.GetNotificationNameFormat(user))
		} else {
			profiles, _, appErr = c.App.GetGroupMemberUsersPage(inGroupId, c.Params["page"].(int), c.Params["per_page"].(int), userGetOptions.ViewRestrictions)
		}
		...
		profiles, appErr = c.App.GetUsersNotInGroupPage(notInGroupId, c.Params["page"].(int), c.Params["per_page"].(int), userGetOptions.ViewRestrictions)
		if appErr != nil {
			c.Err = appErr
			return
		}
...
func searchUsers2(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	users, count, appErr := c.App.User().SearchUsers(props)
	if appErr != nil {
		c.Err = appErr
		return
	}

	res := model_utils.ResponseList{
		Items:      users,
		TotalCount: count,
	}
...
func updateUser(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	if user.Email != "" && ouser.Email != user.Email && c.AppContext.Session().UserId == userIdStr {
...
func patchUser(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	ouser, err := c.App.GetUser(userIdStr)
	if err != nil {
		c.SetInvalidParam("user_id")
		return
	}
	...
	// If eMail update is attempted by the currently logged in user, check if correct password was provided
	if patch.Email != nil && ouser.Email != *patch.Email && c.AppContext.Session().UserId == userIdStr {
	...
	ruser, err := c.App.PatchUser(c.AppContext, userIdStr, &patch, c.IsSystemAdmin())
	if err != nil {
		c.Err = err
		return
	}
...
func deleteUser(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	if userIdStr == c.AppContext.Session().UserId && !*c.App.Config().TeamSettings.EnableUserDeactivation && !c.App.SessionHasPermissionTo(*c.AppContext.Session(), model.PermissionManageSystem) {
		c.Err = model.NewAppError("deleteUser", "api.user.update_active.not_enable.app_error", nil, "userId="+userIdStr, http.StatusUnauthorized)
		return
	}
	...
	if permanent {
		if *c.App.Config().ServiceSettings.EnableAPIUserDeletion {
			...
			if usrErr == nil && loggedUser != nil && loggedUser.IsSystemAdmin() {
				...
				err = model.NewAppError("deleteUser", "api.user.delete_user.not_enabled.for_admin.app_error", nil, "userId="+userIdStr, http.StatusUnauthorized)
			} else {
				err = model.NewAppError("deleteUser", "api.user.delete_user.not_enabled.app_error", nil, "userId="+userIdStr, http.StatusUnauthorized)
			}
		}
	} else {
...
func updateUserRoles(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	user, err := c.App.UpdateUserRoles(c.AppContext, userIdStr, newRoles, true)
	if err != nil {
		c.Err = err
		return
	}
	...
	auditRec.AddEventResultState(user)
	auditRec.AddEventObjectType("user")
	c.LogAudit(fmt.Sprintf("user=%s roles=%s", userIdStr, newRoles))
...
func updateUserActive(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	isSelfDeactivate := !active && userIdStr == c.AppContext.Session().UserId

	if !isSelfDeactivate && !c.App.SessionHasPermissionTo(*c.AppContext.Session(), model.PermissionSysconsoleWriteUserManagementUsers) {
		c.Err = model.NewAppError("updateUserActive", "api.user.update_active.permissions.app_error", nil, "userId="+userIdStr, http.StatusForbidden)
		return
	}

	// if EnableUserDeactivation flag is disabled the user cannot deactivate himself.
	if isSelfDeactivate && !*c.App.Config().TeamSettings.EnableUserDeactivation {
		c.Err = model.NewAppError("updateUserActive", "api.user.update_active.not_enable.app_error", nil, "userId="+userIdStr, http.StatusUnauthorized)
		return
	}
	...
	if active && user.IsGuest() && !*c.App.Config().GuestAccountsSettings.Enable {
		c.Err = model.NewAppError("updateUserActive", "api.user.update_active.cannot_enable_guest_when_guest_feature_is_disabled.app_error", nil, "userId="+userIdStr, http.StatusUnauthorized)
		return
	}

	if user.AuthService == model.UserAuthServiceLdap {
		c.Err = model.NewAppError("updateUserActive", "api.user.update_active.cannot_modify_status_when_user_is_managed_by_ldap.app_error", nil, "userId="+userIdStr, http.StatusForbidden)
		return
	}
...
func updateUserAuth(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	user, err := c.App.UpdateUserAuth(c.AppContext, userIdStr, &userAuth)
	if err != nil {
		c.Err = err
		return
	}
	...
	c.LogAudit(fmt.Sprintf("updated user %s auth to service=%v", userIdStr, user.AuthService))
...
func updateUserMfa(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	if appErr := c.App.MFARequired(c.AppContext); !c.AppContext.Session().Local && c.AppContext.Session().UserId != userIdStr && appErr != nil {
		c.Err = appErr
		return
	}

	if user, appErr := c.App.GetUser(userIdStr); appErr == nil {
		model.AddEventParameterAuditableToAuditRec(auditRec, "user", user)
	}
	...
	if appErr := c.App.UpdateMfa(c.AppContext, activate, userIdStr, code); appErr != nil {
		c.Err = appErr
		return
	}
...
func generateMfaSecret(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	secret, err := c.App.GenerateMfaSecret(userIdStr)
	if err != nil {
		c.Err = err
		return
	}
...
func updatePassword(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	if props["already_hashed"] == "true" {
		if canUpdatePassword {
			err = c.App.UpdateHashedPasswordByUserId(userIdStr, newPassword)
		} else if userIdStr == c.AppContext.Session().UserId {
		...
		if userIdStr == c.AppContext.Session().UserId {
			...
			err = c.App.UpdatePasswordAsUser(c.AppContext, userIdStr, currentPassword, newPassword)
		} else if canUpdatePassword {
			err = c.App.UpdatePasswordByUserIdSendEmail(c.AppContext, userIdStr, newPassword, c.AppContext.T("api.user.reset_password.method"))
		} else {
			err = model.NewAppError("updatePassword", "api.user.update_password.context.app_error", nil, "", http.StatusForbidden)
		}
	}
...
func login(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	if c.App.IsFirstUserAccount() {
		...
		_, err := c.App.CreateUser(c.AppContext, &user)
		if err != nil {
			c.Err = err
			return
		}
...
func getSessions(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	sessions, appErr := c.App.GetSessions(c.AppContext, userIdStr)
	if appErr != nil {
		c.Err = appErr
		return
	}
...
func revokeAllSessionsForUser(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	if err := c.App.RevokeAllSessions(c.AppContext, userIdStr); err != nil {
		c.Err = err
		return
	}
...
func getUserAudits(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	audits, err := c.App.GetAuditsPage(c.AppContext, userIdStr, c.Params["page"].(int), c.Params["per_page"].(int))
	if err != nil {
		c.Err = err
		return
	}
	...
	auditRec.Success()
	auditRec.AddMeta("page", c.Params["page"].(int))
	auditRec.AddMeta("audits_per_page", c.Params["logs_per_page"].(int))
...
func getUserAccessTokens(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	accessTokens, appErr := c.App.GetUserAccessTokens(c.Params["page"].(int), c.Params["per_page"].(int))
	if appErr != nil {
		c.Err = appErr
		return
	}
...
func getUserAccessTokensForUser(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	accessTokens, appErr := c.App.GetUserAccessTokensForUser(userIdStr, c.Params["page"].(int), c.Params["per_page"].(int))
	if appErr != nil {
		c.Err = appErr
		return
	}
...
func getUserAccessToken(c *Context, w http.ResponseWriter, r *http.Request) {
	tokenId := c.RequireParam("token_id", web.RequireValidId)
	if c.Err != nil {
		return
	}
...
func publishUserTyping(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	if ok, _ := c.App.HasPermissionToChannel(c.AppContext, userIdStr, typingRequest.ChannelId, model.PermissionCreatePost); !ok {
		c.SetPermissionError(model.PermissionCreatePost)
		return
	}

	if err := c.App.PublishUserTyping(userIdStr, typingRequest.ChannelId, typingRequest.ParentId); err != nil {
		c.Err = err
		return
	}
...
func convertUserToBot(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	user, appErr := c.App.GetUser(userIdStr)
	if appErr != nil {
		c.Err = appErr
		return
	}
...
func getUploadsForUser(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	uss, appErr := c.App.GetUploadSessionsForUser(userIdStr)
	if appErr != nil {
		c.Err = appErr
		return
	}
...
func getChannelMembersForUser(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	if c.Params["page"].(int) != -1 {
		cursor := &model.ChannelMemberCursor{
			Page:    c.Params["page"].(int),
			PerPage: c.Params["per_page"].(int),
		}
		members, err := c.App.GetChannelMembersWithTeamDataForUserWithPagination(c.AppContext, userIdStr, cursor)
		if err != nil {
			c.Err = err
			return
		}
...
func getThreadsForUser(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	options := model.GetUserThreadsOpts{
		...
		Before:      "",
		After:       "",
		PageSize:    uint64(c.Params["per_page"].(int)),
		Unread:      false,
		Extended:    false,
		Deleted:     false,
		TotalsOnly:  false,
...
func getUsersWithInvalidEmails(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	users, appErr := c.App.GetUsersWithInvalidEmails(c.Params["page"].(int), c.Params["per_page"].(int))
	if appErr != nil {
		c.Err = appErr
		return
	}
...
func resetPasswordFailedAttempts(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	userIdStr := c.Params["user_id"].(string)
	errParams := map[string]any{"userID": userIdStr}
