...
import (
	...
	"github.com/iamleson98/sitename/server/v8/channels/wsapi"
...
func setupTestHelper(tb testing.TB, dbStore store.Store, sqlSettings *model.SqlSettings, searchEngine *searchengine.Broker, enterprise bool, includeCache bool,
	...
	*memoryConfig.ServiceSettings.LocalModeSocketLocation = filepath.Join(tempWorkspace, "sitename_local.sock")
