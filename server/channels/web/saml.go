...
func (w *Web) InitSaml() {
	w.MainRouter.Method(http.MethodGet, "/login/sso/saml", w.APIHandler(loginWithSaml))
	w.MainRouter.Method(http.MethodPost, "/login/sso/saml", w.APIHandlerTrustRequester(completeSaml))
}
