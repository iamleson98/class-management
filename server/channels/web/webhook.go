...
func (w *Web) InitWebhooks() {
	w.MainRouter.Method(http.MethodPost, "/hooks/commands/{id:[A-Za-z0-9]+}", w.APIHandlerTrustRequester(commandWebhook))
	w.MainRouter.Method(http.MethodPost, "/hooks/{id:[A-Za-z0-9]+}", w.APIHandlerTrustRequester(incomingWebhook))
}
