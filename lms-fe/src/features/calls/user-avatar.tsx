...
export function UserAvatar({
        ...
        // failed (e.g. a user uploads their first avatar). Adjusting state
        // during render (the React-recommended pattern for prop-driven resets)
        // instead of an effect, so no cascading render is triggered.
        const [prevPicVersion, setPrevPicVersion] = useState(picVersion)
        if (picVersion !== prevPicVersion) {
                setPrevPicVersion(picVersion)
                setFailed(false)
        }
